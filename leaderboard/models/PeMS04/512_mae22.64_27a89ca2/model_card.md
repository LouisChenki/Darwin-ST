# 模型卡: darwin-st/27a89ca2

- **数据集**: PeMS04
- **排名**: 第 512 名 / 库内 KEEP 实验
- **val MAE**: 22.64
- **val RMSE**: 36.08
- **参数量**: 253.8K
- **实验 id**: 315   **签名**: `27a89ca23e7020d16430af99a3f0a145a631a1e4`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T14:17:46.757844+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.84
...
- 时空块:
  ...
  6. spatial=`dynamic_gat` temporal=`synth_StGraphAttnWithMpsGated_v7` fusion=`parallel` 🔬
  7. spatial=`identity` temporal=`identity` fusion=`iterative`
