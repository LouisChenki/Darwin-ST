# 模型卡: darwin-st/33551e5e

- **数据集**: PeMS04
- **排名**: 第 317 名 / 库内 KEEP 实验
- **val MAE**: 18.96
- **val RMSE**: 31.11
- **参数量**: 207.4K
- **实验 id**: 97   **签名**: `33551e5e8e1a352d6c65f8fdac9f8069a68c23d8`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-26T09:19:05.689553+00:00
