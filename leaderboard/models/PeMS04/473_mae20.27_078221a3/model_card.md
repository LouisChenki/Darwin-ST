# 模型卡: darwin-st/078221a3

- **数据集**: PeMS04
- **排名**: 第 473 名 / 库内 KEEP 实验
- **val MAE**: 20.27
- **val RMSE**: 32.55
- **参数量**: 144.7K
- **实验 id**: 40   **签名**: `078221a3b3ea46738f1dcf4db6ce615163e9fc08`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-25T04:38:24.815641+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +2.47
