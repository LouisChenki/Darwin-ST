# 模型卡: darwin-st/3807bd1d

- **数据集**: PeMS04
- **排名**: 第 325 名 / 库内 KEEP 实验
- **val MAE**: 18.98
- **val RMSE**: 31.04
- **参数量**: 169.5K
- **实验 id**: 219   **签名**: `3807bd1ddb65fdbd7b16473f530abbe19a7f5027`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-28T14:17:14.685368+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.18
...
- 时空块:
  0. spatial=`synth_ParallelMinimalSufficiencyAttn` temporal=`synth_StGraphAttnWithMpsGated_v6` fusion=`cross` 🔬
