# 模型卡: darwin-st/9a96ef4d

- **数据集**: PeMS04
- **排名**: 第 180 名 / 库内 KEEP 实验
- **val MAE**: 18.65
- **val RMSE**: 30.62
- **参数量**: 202.9K
- **实验 id**: 258   **签名**: `9a96ef4d701ea6d5c8dcd359b9eda0b06ed70e01`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-29T12:59:08.484672+00:00
...
- 时空块:
  ...
  1. spatial=`synth_InfoBootstrapResidual` temporal=`st_graph_attn` fusion=`cross` 🔬
