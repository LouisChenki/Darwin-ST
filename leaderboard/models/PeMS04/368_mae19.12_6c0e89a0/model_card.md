# 模型卡: darwin-st/6c0e89a0

- **数据集**: PeMS04
- **排名**: 第 368 名 / 库内 KEEP 实验
- **val MAE**: 19.12
- **val RMSE**: 31.22
- **参数量**: 278.2K
- **实验 id**: 611   **签名**: `6c0e89a0a740d8849a584fd9efead01785b24d08`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-05T11:11:34.616253+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.32
...
- 时空块:
  ...
  6. spatial=`adaptive` temporal=`synth_StGraphAttnWithMpsGated_v25` fusion=`iterative` 🔬
