# 模型卡: darwin-st/158ccb1f

- **数据集**: PeMS04
- **排名**: 第 496 名 / 库内 KEEP 实验
- **val MAE**: 22.41
- **val RMSE**: 35.49
- **参数量**: 209.5K
- **实验 id**: 586   **签名**: `158ccb1f30010333b7a972c8bf231b0285d2f606`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-04T20:59:07.133002+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.61
...
- 时空块:
  ...
  6. spatial=`identity` temporal=`identity` fusion=`residual`
