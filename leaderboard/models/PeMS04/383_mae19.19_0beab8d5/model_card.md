# 模型卡: darwin-st/0beab8d5

- **数据集**: PeMS04
- **排名**: 第 383 名 / 库内 KEEP 实验
- **val MAE**: 19.19
- **val RMSE**: 31.30
- **参数量**: 268.6K
- **实验 id**: 539   **签名**: `0beab8d5c68b1ddf7b3386fb1ef8311033cefffb`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-03T23:18:45.861730+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.39
...
- 时空块:
  ...
  4. spatial=`synth_InfoBootstrapResidual` temporal=`stjoint_conv` fusion=`parallel` 🔬
