# 模型卡: darwin-st/84f3be5a

- **数据集**: PeMS04
- **排名**: 第 203 名 / 库内 KEEP 实验
- **val MAE**: 18.68
- **val RMSE**: 30.73
- **参数量**: 209.0K
- **实验 id**: 452   **签名**: `84f3be5ad05a6c4b4a641d0a532c8df412be463c`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T04:02:09.969815+00:00
...
- 时空块:
  ...
  5. spatial=`stjoint_conv` temporal=`synth_InfoBootstrapResidual` fusion=`residual` 🔬
