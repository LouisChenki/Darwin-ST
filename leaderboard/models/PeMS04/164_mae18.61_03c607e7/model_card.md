# 模型卡: darwin-st/03c607e7

- **数据集**: PeMS04
- **排名**: 第 164 名 / 库内 KEEP 实验
- **val MAE**: 18.61
- **val RMSE**: 30.64
- **参数量**: 242.6K
- **实验 id**: 439   **签名**: `03c607e7ed5a3f4b288367fcb49b8e6fd8bd43c6`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T22:16:44.636850+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.81
...
- 时空块:
  ...
  3. spatial=`gat` temporal=`gru` fusion=`cross`
  ...
  6. spatial=`gcn` temporal=`synth_StGraphAttnWithMpsGated_v7` fusion=`cross` 🔬
