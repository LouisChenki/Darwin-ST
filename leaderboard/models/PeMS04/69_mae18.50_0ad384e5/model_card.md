# 模型卡: darwin-st/0ad384e5

- **数据集**: PeMS04
- **排名**: 第 69 名 / 库内 KEEP 实验
- **val MAE**: 18.50
- **val RMSE**: 30.54
- **参数量**: 209.5K
- **实验 id**: 311   **签名**: `0ad384e531f67205b82944e72da799b51fa8a6d3`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T12:24:11.666019+00:00
...
- 时空块:
  ...
  3. spatial=`synth_InfoBootstrapResidual` temporal=`identity` fusion=`cross` 🔬
