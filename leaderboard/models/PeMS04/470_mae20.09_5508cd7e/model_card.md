# 模型卡: darwin-st/5508cd7e

- **数据集**: PeMS04
- **排名**: 第 470 名 / 库内 KEEP 实验
- **val MAE**: 20.09
- **val RMSE**: 32.23
- **参数量**: 160.3K
- **实验 id**: 395   **签名**: `5508cd7e812380d2563aa88f7021c263391fb607`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T01:03:07.152707+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +2.29
