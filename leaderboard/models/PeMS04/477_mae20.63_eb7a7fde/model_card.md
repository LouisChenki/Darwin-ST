# 模型卡: darwin-st/eb7a7fde

- **数据集**: PeMS04
- **排名**: 第 477 名 / 库内 KEEP 实验
- **val MAE**: 20.63
- **val RMSE**: 33.18
- **参数量**: 623.9K
- **实验 id**: 218   **签名**: `eb7a7fde429b6528adb87a1da8ecc1dfbd2e49d3`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-28T14:16:39.980565+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +2.83
- **评测协议**: masked metric; MAE averaged over 12 horizons; split 6/2/2

## 架构

- 深度 (blocks): 2   hidden: 192   邻接: none
- 时空块:
