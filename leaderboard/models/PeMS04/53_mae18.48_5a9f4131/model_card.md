# 模型卡: darwin-st/5a9f4131

- **数据集**: PeMS04
- **排名**: 第 53 名 / 库内 KEEP 实验
- **val MAE**: 18.48
- **val RMSE**: 30.55
- **参数量**: 257.9K
- **实验 id**: 653   **签名**: `5a9f4131b51384e3c5801006a858dac891dd7e68`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-06T10:02:16.556405+00:00
...
- 时空块:
  ...
  3. spatial=`dynamic_gat` temporal=`identity` fusion=`parallel`
