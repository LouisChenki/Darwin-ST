# 模型卡: darwin-st/506a801a

- **数据集**: PeMS04
- **排名**: 第 208 名 / 库内 KEEP 实验
- **val MAE**: 18.69
- **val RMSE**: 30.76
- **参数量**: 257.9K
- **实验 id**: 633   **签名**: `506a801afa6214f1fa6b256daac94fbe9e12b188`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-05T23:31:38.701614+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.89
