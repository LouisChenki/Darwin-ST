# 模型卡: darwin-st/e992cc34

- **数据集**: PeMS04
- **排名**: 第 488 名 / 库内 KEEP 实验
- **val MAE**: 22.24
- **val RMSE**: 35.38
- **参数量**: 190.6K
- **实验 id**: 466   **签名**: `e992cc3405cbb1d5892006d56745a195c0b11f96`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T10:44:25.039571+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.44
...
- 时空块:
  ...
  1. spatial=`st_separable` temporal=`synth_StGraphAttnWithMpsGated_v19` fusion=`cross` 🔬
...
### `synth_StGraphAttnWithMpsGated_v19`
- **组合方式**: gated_routed
- **源机制 (跨域)**: minimal_predictive_sufficiency
- **该算子实测 MAE**: 18.78
- **算子代码**: [`operators/synth_StGraphAttnWithMpsGated_v19.py`](operators/synth_StGraphAttnWithMpsGated_v19.py)
