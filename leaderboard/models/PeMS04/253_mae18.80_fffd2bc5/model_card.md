# 模型卡: darwin-st/fffd2bc5

- **数据集**: PeMS04
- **排名**: 第 253 名 / 库内 KEEP 实验
- **val MAE**: 18.80
- **val RMSE**: 30.87
- **参数量**: 213.3K
- **实验 id**: 236   **签名**: `fffd2bc592314fafc424509eda9a6daf8a1d1111`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-28T20:10:09.604607+00:00
...
- 时空块:
  ...
  4. spatial=`synth_InfoBootstrapResidual` temporal=`dynamic_gat` fusion=`cross` 🔬
  5. spatial=`mixhop` temporal=`synth_InfoBootstrapResidual` fusion=`residual` 🔬
