# 模型卡: darwin-st/413b861d

- **数据集**: PeMS04
- **排名**: 第 286 名 / 库内 KEEP 实验
- **val MAE**: 18.88
- **val RMSE**: 30.95
- **参数量**: 544.4K
- **实验 id**: 176   **签名**: `413b861d1970f58b369404522cb8d673beed167b`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-27T21:22:51.659883+00:00
...
- 时空块:
  ...
  2. spatial=`gwnet_adp` temporal=`synth_StGraphAttnWithMpsGated_v2` fusion=`cross` 🔬
