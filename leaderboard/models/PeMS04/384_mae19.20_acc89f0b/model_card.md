# 模型卡: darwin-st/acc89f0b

- **数据集**: PeMS04
- **排名**: 第 384 名 / 库内 KEEP 实验
- **val MAE**: 19.20
- **val RMSE**: 31.26
- **参数量**: 155.1K
- **实验 id**: 55   **签名**: `acc89f0b702ba74b7f90f0c9e18e79f40b4d0a51`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-25T09:20:09.776043+00:00
...
- 时空块:
  ...
  1. spatial=`adaptive` temporal=`series_decomp_attn` fusion=`residual`
