# 模型卡: darwin-st/59d20ae5

- **数据集**: PeMS04
- **排名**: 第 323 名 / 库内 KEEP 实验
- **val MAE**: 18.97
- **val RMSE**: 31.00
- **参数量**: 1.27M
- **实验 id**: 297   **签名**: `59d20ae543a75881d7fbf6b3cb7b88afb362c7a8`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T05:42:11.365405+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.17
- **评测协议**: masked metric; MAE averaged over 12 horizons; split 6/2/2

## 架构

- 深度 (blocks): 5   hidden: 192   邻接: rw
- 时空块:
