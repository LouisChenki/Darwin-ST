# 模型卡: darwin-st/37208961

- **数据集**: PeMS04
- **排名**: 第 283 名 / 库内 KEEP 实验
- **val MAE**: 18.87
- **val RMSE**: 30.91
- **参数量**: 198.9K
- **实验 id**: 321   **签名**: `37208961d0765cf7ab413490874b0ec590b19b29`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T16:11:35.561769+00:00
...
```json
{
  "lr": 0.0032224128266342793,
  "weight_decay": 1.0569648727055736e-06,
  "dropout": 0.1073205091755442,
  "batch_size": 32,
  "lr_schedule": "cosine",
  "num_heads": 2
}
