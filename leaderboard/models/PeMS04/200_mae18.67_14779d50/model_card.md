# 模型卡: darwin-st/14779d50

- **数据集**: PeMS04
- **排名**: 第 200 名 / 库内 KEEP 实验
- **val MAE**: 18.67
- **val RMSE**: 30.76
- **参数量**: 196.7K
- **实验 id**: 309   **签名**: `14779d507f2212b10f68239e13d4b37345bed563`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T11:12:53.524109+00:00
...
- 时空块:
  ...
  4. spatial=`synth_InfoBootstrapResidual` temporal=`stjoint_conv` fusion=`sequential` 🔬
