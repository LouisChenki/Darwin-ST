...
- **val RMSE**: 30.53
- **参数量**: 264.8K
- **实验 id**: 639   **签名**: `c55156b648b30bbe027acc1deeaa9146036f705c`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-06T02:17:46.559198+00:00
...
- 时空块:
  ...
  6. spatial=`synth_StGraphAttnWithMpsGated_v16` temporal=`gru` fusion=`cross` 🔬
