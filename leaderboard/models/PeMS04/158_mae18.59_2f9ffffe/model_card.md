# 模型卡: darwin-st/2f9ffffe

- **数据集**: PeMS04
- **排名**: 第 158 名 / 库内 KEEP 实验
- **val MAE**: 18.59
- **val RMSE**: 30.66
- **参数量**: 240.6K
- **实验 id**: 375   **签名**: `2f9ffffea50afcc2f7f71e34357473e7f16b3c71`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T16:02:41.652077+00:00
...
- 时空块:
  ...
  3. spatial=`dynamic_gat` temporal=`identity` fusion=`sequential`
