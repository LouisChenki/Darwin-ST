# 模型卡: darwin-st/db2084c1

- **数据集**: PeMS04
- **排名**: 第 267 名 / 库内 KEEP 实验
- **val MAE**: 18.83
- **val RMSE**: 30.89
- **参数量**: 235.4K
- **实验 id**: 516   **签名**: `db2084c1589c2bfc0702c9745cedd00a565f530c`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-03T11:26:44.930102+00:00
