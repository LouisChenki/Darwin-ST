# 模型卡: darwin-st/69dd699d

- **数据集**: PeMS04
- **排名**: 第 387 名 / 库内 KEEP 实验
- **val MAE**: 19.20
- **val RMSE**: 31.28
- **参数量**: 220.3K
- **实验 id**: 556   **签名**: `69dd699d80de82040e663c7dd7faf4e392079631`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-04T06:41:42.539639+00:00
...
- 时空块:
  ...
  6. spatial=`synth_StGraphAttnWithMpsGated_v7` temporal=`st_graph_attn` fusion=`sequential` 🔬
