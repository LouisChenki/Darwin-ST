# 模型卡: darwin-st/2c7a0c60

- **数据集**: PeMS04
- **排名**: 第 229 名 / 库内 KEEP 实验
- **val MAE**: 18.75
- **val RMSE**: 30.82
- **参数量**: 249.1K
- **实验 id**: 592   **签名**: `2c7a0c602242e4786a6236b09e4a66f69a8e7e2b`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-05T00:13:22.578122+00:00
...
- 时空块:
  ...
  6. spatial=`synth_InfoBootstrapResidual` temporal=`series_decomp_attn` fusion=`residual` 🔬
