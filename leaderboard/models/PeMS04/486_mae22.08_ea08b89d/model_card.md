# 模型卡: darwin-st/ea08b89d

- **数据集**: PeMS04
- **排名**: 第 486 名 / 库内 KEEP 实验
- **val MAE**: 22.08
- **val RMSE**: 35.15
- **参数量**: 215.5K
- **实验 id**: 229   **签名**: `ea08b89d1100eaeb1f7e91b987ce065d8538120e`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-28T17:42:05.968435+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.28
...
- 时空块:
  ...
  5. spatial=`gcn` temporal=`attn` fusion=`sequential`
