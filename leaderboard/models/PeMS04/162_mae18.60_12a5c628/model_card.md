# 模型卡: darwin-st/12a5c628

- **数据集**: PeMS04
- **排名**: 第 162 名 / 库内 KEEP 实验
- **val MAE**: 18.60
- **val RMSE**: 30.69
- **参数量**: 205.3K
- **实验 id**: 432   **签名**: `12a5c62810611063fc25c8168cfd1a8dccf515b2`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T16:59:45.070244+00:00
...
- 时空块:
  ...
  5. spatial=`synth_StGraphAttnWithMpsGated_v4` temporal=`synth_StGraphAttnWithMpsGated_v11` fusion=`residual` 🔬
