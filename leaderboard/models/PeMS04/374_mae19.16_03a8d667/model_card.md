# 模型卡: darwin-st/03a8d667

- **数据集**: PeMS04
- **排名**: 第 374 名 / 库内 KEEP 实验
- **val MAE**: 19.16
- **val RMSE**: 31.32
- **参数量**: 231.7K
- **实验 id**: 156   **签名**: `03a8d6677cb49065bdfc752a8328ae358858fe50`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-27T13:25:49.348717+00:00
...
- 时空块:
  ...
  2. spatial=`st_graph_attn` temporal=`multiscale_tcn` fusion=`cross`
