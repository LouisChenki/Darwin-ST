# 模型卡: darwin-st/adfe30b6

- **数据集**: PeMS04
- **排名**: 第 475 名 / 库内 KEEP 实验
- **val MAE**: 20.54
- **val RMSE**: 32.82
- **参数量**: 214.6K
- **实验 id**: 610   **签名**: `adfe30b65658669257bd2321c7ed6dcf01a725b3`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-05T11:07:20.629787+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +2.74
...
- 身份嵌入: node=False(128) tod=True(64) dow=True(64)
