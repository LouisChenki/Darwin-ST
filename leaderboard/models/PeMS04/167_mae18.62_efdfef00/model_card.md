# 模型卡: darwin-st/efdfef00

- **数据集**: PeMS04
- **排名**: 第 167 名 / 库内 KEEP 实验
- **val MAE**: 18.62
- **val RMSE**: 30.77
- **参数量**: 217.6K
- **实验 id**: 244   **签名**: `efdfef00d7ba9525fad0b5d21c70167c22b36d40`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-29T06:32:43.374246+00:00
...
- 时空块:
  0. spatial=`st_graph_attn` temporal=`gru` fusion=`cross`
