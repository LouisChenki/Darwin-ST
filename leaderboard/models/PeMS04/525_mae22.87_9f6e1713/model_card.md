# 模型卡: darwin-st/9f6e1713

- **数据集**: PeMS04
- **排名**: 第 525 名 / 库内 KEEP 实验
- **val MAE**: 22.87
- **val RMSE**: 36.20
- **参数量**: 196.7K
- **实验 id**: 358   **签名**: `9f6e17130fd4411ccc7f9d3f41d136d7680228dd`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T07:56:36.397337+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +5.07
...
- 时空块:
  ...
  5. spatial=`synth_StGraphAttnWithMpsGated_v4` temporal=`synth_InfoBootstrapResidual` fusion=`sequential` 🔬
