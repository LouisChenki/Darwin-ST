# 模型卡: darwin-st/efacf293

- **数据集**: PeMS04
- **排名**: 第 223 名 / 库内 KEEP 实验
- **val MAE**: 18.73
- **val RMSE**: 30.83
- **参数量**: 262.8K
- **实验 id**: 532   **签名**: `efacf293fb47180a756b786ef3994585414f997b`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-03T20:04:51.658051+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.93
...
- 时空块:
  ...
  4. spatial=`synth_StGraphAttnWithMpsGated_v3` temporal=`stjoint_conv` fusion=`cross` 🔬
