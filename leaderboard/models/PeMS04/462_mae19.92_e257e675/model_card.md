# 模型卡: darwin-st/e257e675

- **数据集**: PeMS04
- **排名**: 第 462 名 / 库内 KEEP 实验
- **val MAE**: 19.92
- **val RMSE**: 32.12
- **参数量**: 190.7K
- **实验 id**: 476   **签名**: `e257e675dbf4c6fa324e7adb923d5b2d94c3eb2e`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T14:41:39.655003+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +2.12
...
- 时空块:
  ...
  5. spatial=`synth_StGraphAttnWithMpsGated_v4` temporal=`synth_StGraphAttnWithMpsGated_v18` fusion=`residual` 🔬
- 身份嵌入: node=False(64) tod=True(96) dow=True(64)
