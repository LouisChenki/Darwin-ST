# 模型卡: darwin-st/1fc3bc34

- **数据集**: PeMS04
- **排名**: 第 18 名 / 库内 KEEP 实验
- **val MAE**: 18.38
- **val RMSE**: —
- **参数量**: 404.7K
- **实验 id**: 535   **签名**: `1fc3bc3482db121767b1080c322485477fa3c430`
- **run_tag**: exp/sota-24h   **时间**: 2026-06-30T22:24:42.128744+00:00
...
- 时空块:
  0. spatial=`identity` temporal=`identity` fusion=`parallel`
