# 模型卡: darwin-st/76498990

- **数据集**: PeMS04
- **排名**: 第 272 名 / 库内 KEEP 实验
- **val MAE**: 18.84
- **val RMSE**: 30.92
- **参数量**: 207.2K
- **实验 id**: 140   **签名**: `7649899059cb256a4fd25f81d54a0be531a5e4c6`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-27T07:16:25.042269+00:00
...
- 时空块:
  ...
  3. spatial=`synth_StGraphAttnWithMpsGated_v4` temporal=`synth_StGraphAttnWithMpsGated_v2` fusion=`parallel` 🔬
