# 模型卡: darwin-st/fa2b9dc3

- **数据集**: PeMS04
- **排名**: 第 421 名 / 库内 KEEP 实验
- **val MAE**: 19.39
- **val RMSE**: 31.54
- **参数量**: 220.2K
- **实验 id**: 83   **签名**: `fa2b9dc397f8e7970366958ca8105de341b1c5d4`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-25T23:22:06.909730+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.59
