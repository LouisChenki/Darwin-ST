# 模型卡: darwin-st/d65b5c74

- **数据集**: PeMS04
- **排名**: 第 181 名 / 库内 KEEP 实验
- **val MAE**: 18.65
- **val RMSE**: 30.75
- **参数量**: 208.7K
- **实验 id**: 503   **签名**: `d65b5c74a21d0090af86620af66a297f2f770cb7`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-03T05:25:10.575549+00:00
...
- 时空块:
  ...
  2. spatial=`gat` temporal=`st_separable` fusion=`cross`
