# 模型卡: darwin-st/0cd34852

- **数据集**: PeMS04
- **排名**: 第 321 名 / 库内 KEEP 实验
- **val MAE**: 18.97
- **val RMSE**: 31.07
- **参数量**: 225.5K
- **实验 id**: 289   **签名**: `0cd348528abc07cd9916a1f5aea11806665cf2e2`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T02:09:40.520814+00:00
...
- 时空块:
  ...
  5. spatial=`diffusion` temporal=`synth_InfoBootstrapResidual` fusion=`residual` 🔬
