# 模型卡: darwin-st/f851a974

- **数据集**: PeMS04
- **排名**: 第 523 名 / 库内 KEEP 实验
- **val MAE**: 22.86
- **val RMSE**: 36.09
- **参数量**: 250.5K
- **实验 id**: 460   **签名**: `f851a974d5e147f04814607ef9616a5941c2c965`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T07:07:56.739298+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +5.06
...
- 时空块:
  ...
  6. spatial=`synth_StGraphAttnWithMpsGated_v21` temporal=`synth_StGraphAttnWithMpsGated_v21` fusion=`sequential_ts` 🔬
