# 模型卡: darwin-st/a2d8fe29

- **数据集**: PeMS04
- **排名**: 第 258 名 / 库内 KEEP 实验
- **val MAE**: 18.82
- **val RMSE**: 30.92
- **参数量**: 293.8K
- **实验 id**: 619   **签名**: `a2d8fe298a7639ae3a5c7862dfd955f629873a6a`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-05T15:36:33.853359+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.02
...
- 时空块:
  ...
  7. spatial=`synth_StGraphAttnWithMpsGated_v23` temporal=`dynamic_gat` fusion=`sequential_ts` 🔬
