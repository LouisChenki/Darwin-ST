# 模型卡: darwin-st/848a33f6

- **数据集**: PeMS04
- **排名**: 第 284 名 / 库内 KEEP 实验
- **val MAE**: 18.88
- **val RMSE**: 30.91
- **参数量**: 240.6K
- **实验 id**: 377   **签名**: `848a33f697f1cc34dcc6a8d61d6582d7b0792650`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T16:41:44.639032+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.08
