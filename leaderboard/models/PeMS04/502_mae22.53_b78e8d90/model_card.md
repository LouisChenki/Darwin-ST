# 模型卡: darwin-st/b78e8d90

- **数据集**: PeMS04
- **排名**: 第 502 名 / 库内 KEEP 实验
- **val MAE**: 22.53
- **val RMSE**: 35.74
- **参数量**: 796.1K
- **实验 id**: 646   **签名**: `b78e8d90e41859f1624ccd8fece0dcd6b38ffdfb`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-06T06:53:08.943958+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.73
- **评测协议**: masked metric; MAE averaged over 12 horizons; split 6/2/2

## 架构

- 深度 (blocks): 7   hidden: 128   邻接: rw
- 时空块:
