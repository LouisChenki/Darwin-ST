# 模型卡: darwin-st/bbfa5acd

- **数据集**: PeMS04
- **排名**: 第 412 名 / 库内 KEEP 实验
- **val MAE**: 19.32
- **val RMSE**: 31.46
- **参数量**: 215.1K
- **实验 id**: 88   **签名**: `bbfa5acd249a685911a66270879a0eb4c2dfed85`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-26T03:28:51.243655+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.52
...
```json
{
  "lr": 0.0011010285473548075,
  "weight_decay": 4.358937700693006e-06,
  "dropout": 0.20654293816677632,
  "batch_size": 16,
  "lr_schedule": "plateau",
  "num_heads": 2
}
