# 模型卡: darwin-st/53ffffdc

- **数据集**: PeMS04
- **排名**: 第 479 名 / 库内 KEEP 实验
- **val MAE**: 21.42
- **val RMSE**: 34.20
- **参数量**: 1.60M
- **实验 id**: 677   **签名**: `53ffffdcfcba1a6e659afe8d66d1b08d3c78e6df`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-06T22:15:11.902262+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +3.62
- **评测协议**: masked metric; MAE averaged over 12 horizons; split 6/2/2

## 架构

- 深度 (blocks): 7   hidden: 192   邻接: rw
- 时空块:
