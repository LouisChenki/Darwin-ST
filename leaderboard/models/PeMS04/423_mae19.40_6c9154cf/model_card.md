# 模型卡: darwin-st/6c9154cf

- **数据集**: PeMS04
- **排名**: 第 423 名 / 库内 KEEP 实验
- **val MAE**: 19.40
- **val RMSE**: 31.38
- **参数量**: 209.2K
- **实验 id**: 394   **签名**: `6c9154cfca999caca9f75aa3d82f515bb1277612`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T00:31:03.615901+00:00
...
- 时空块:
  0. spatial=`synth_StGraphAttnWithMpsGated_v7` temporal=`synth_StGraphAttnWithMpsGated` fusion=`cross` 🔬
