# 模型卡: darwin-st/f0afb80b

- **数据集**: PeMS04
- **排名**: 第 334 名 / 库内 KEEP 实验
- **val MAE**: 19.01
- **val RMSE**: 31.10
- **参数量**: 198.7K
- **实验 id**: 59   **签名**: `f0afb80b91f67bf7f6dbc2a2e7904d7c48aaf5c7`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-25T10:43:41.427366+00:00
...
- 时空块:
  ...
  3. spatial=`identity` temporal=`dynamic_gat` fusion=`iterative`
