# 模型卡: darwin-st/6eea4ebd

- **数据集**: PeMS04
- **排名**: 第 359 名 / 库内 KEEP 实验
- **val MAE**: 19.08
- **val RMSE**: 31.22
- **参数量**: 215.2K
- **实验 id**: 58   **签名**: `6eea4ebdbcdd0d9b1723ad0a91cbac1c7376c344`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-25T10:40:08.608596+00:00
...
- 时空块:
  ...
  2. spatial=`st_graph_attn` temporal=`tcn` fusion=`cross`
