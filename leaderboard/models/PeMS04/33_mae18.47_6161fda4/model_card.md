# 模型卡: darwin-st/6161fda4

- **数据集**: PeMS04
- **排名**: 第 33 名 / 库内 KEEP 实验
- **val MAE**: 18.47
- **val RMSE**: 30.49
- **参数量**: 228.4K
- **实验 id**: 438   **签名**: `6161fda46d920595c2699efdcad39ed176672592`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T22:09:37.640071+00:00
...
- 时空块:
  ...
  6. spatial=`st_graph_attn` temporal=`synth_StGraphAttnWithMpsGated_v9` fusion=`cross` 🔬
