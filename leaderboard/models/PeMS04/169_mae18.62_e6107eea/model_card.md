# 模型卡: darwin-st/e6107eea

- **数据集**: PeMS04
- **排名**: 第 169 名 / 库内 KEEP 实验
- **val MAE**: 18.62
- **val RMSE**: 30.73
- **参数量**: 275.6K
- **实验 id**: 620   **签名**: `e6107eea707c47acb55e96822b58966a8e1542e4`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-05T15:59:17.898899+00:00
...
- 身份嵌入: node=True(128) tod=True(64) dow=True(128)
