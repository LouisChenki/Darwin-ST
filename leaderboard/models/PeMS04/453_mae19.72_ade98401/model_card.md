# 模型卡: darwin-st/ade98401

- **数据集**: PeMS04
- **排名**: 第 453 名 / 库内 KEEP 实验
- **val MAE**: 19.72
- **val RMSE**: 31.97
- **参数量**: 221.5K
- **实验 id**: 383   **签名**: `ade9840116922c50eed00d54c91dfd27868afb7f`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T19:41:11.955461+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.92
...
- 时空块:
  ...
  6. spatial=`gat` temporal=`synth_StGraphAttnWithMpsGated_v16` fusion=`cross` 🔬
...
### `synth_StGraphAttnWithMpsGated_v16`
- **组合方式**: gated_routed
- **源机制 (跨域)**: minimal_predictive_sufficiency
- **该算子实测 MAE**: 18.78
- **算子代码**: [`operators/synth_StGraphAttnWithMpsGated_v16.py`](operators/synth_StGraphAttnWithMpsGated_v16.py)
