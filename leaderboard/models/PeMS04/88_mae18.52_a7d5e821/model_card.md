# 模型卡: darwin-st/a7d5e821

- **数据集**: PeMS04
- **排名**: 第 88 名 / 库内 KEEP 实验
- **val MAE**: 18.52
- **val RMSE**: 30.53
- **参数量**: 289.3K
- **实验 id**: 605   **签名**: `a7d5e82149429df0b0303c2ddc7a8fdddb58ee37`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-05T07:07:29.187670+00:00
...
- 时空块:
  ...
  7. spatial=`synth_StGraphAttnWithMpsGated_v25` temporal=`synth_StGraphAttnWithMpsGated_v6` fusion=`residual` 🔬
