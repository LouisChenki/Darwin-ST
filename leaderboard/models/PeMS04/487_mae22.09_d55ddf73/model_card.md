# 模型卡: darwin-st/d55ddf73

- **数据集**: PeMS04
- **排名**: 第 487 名 / 库内 KEEP 实验
- **val MAE**: 22.09
- **val RMSE**: 35.07
- **参数量**: 244.2K
- **实验 id**: 338   **签名**: `d55ddf734a2d02e99fb369743639569c028b7a82`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T00:08:02.999074+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.29
...
- 时空块:
  ...
  6. spatial=`cheb` temporal=`synth_StGraphAttnWithMpsGated` fusion=`sequential_ts` 🔬
- 身份嵌入: node=True(64) tod=True(128) dow=True(64)
