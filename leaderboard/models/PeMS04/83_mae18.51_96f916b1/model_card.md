# 模型卡: darwin-st/96f916b1

- **数据集**: PeMS04
- **排名**: 第 83 名 / 库内 KEEP 实验
- **val MAE**: 18.51
- **val RMSE**: 30.60
- **参数量**: 266.6K
- **实验 id**: 519   **签名**: `96f916b18e429c0f9b02a8ca4ba7e43de1e0ba31`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-03T12:53:34.240860+00:00
...
- 时空块:
  ...
  3. spatial=`synth_StGraphAttnWithMpsGated_v20` temporal=`identity` fusion=`cross` 🔬
