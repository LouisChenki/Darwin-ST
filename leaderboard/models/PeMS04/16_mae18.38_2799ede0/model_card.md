...
- **val RMSE**: —
- **参数量**: 1.33M
- **实验 id**: 449   **签名**: `2799ede04a7c755ed21585150474fbaabebe344e`
- **run_tag**: exp/sota-24h   **时间**: 2026-06-30T00:30:07.080620+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.58
- **评测协议**: masked metric; MAE averaged over 12 horizons; split 6/2/2

## 架构

- 深度 (blocks): 4   hidden: 192   邻接: none
- 时空块:
