# 模型卡: darwin-st/5cebeb49

- **数据集**: PeMS04
- **排名**: 第 149 名 / 库内 KEEP 实验
- **val MAE**: 18.58
- **val RMSE**: 30.78
- **参数量**: 199.0K
- **实验 id**: 405   **签名**: `5cebeb49fd45686636cd85190362505835adcf0f`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T04:38:22.045823+00:00
...
- 时空块:
  ...
  3. spatial=`synth_StGraphAttnWithMpsGated_v13` temporal=`identity` fusion=`cross` 🔬
