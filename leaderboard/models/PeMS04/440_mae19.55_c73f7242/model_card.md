# 模型卡: darwin-st/c73f7242

- **数据集**: PeMS04
- **排名**: 第 440 名 / 库内 KEEP 实验
- **val MAE**: 19.55
- **val RMSE**: 31.55
- **参数量**: 195.1K
- **实验 id**: 283   **签名**: `c73f7242395d9183cedd16ce498328b733d98505`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-29T23:34:24.155846+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.75
