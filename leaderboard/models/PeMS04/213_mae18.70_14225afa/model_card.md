# 模型卡: darwin-st/14225afa

- **数据集**: PeMS04
- **排名**: 第 213 名 / 库内 KEEP 实验
- **val MAE**: 18.70
- **val RMSE**: 30.73
- **参数量**: 196.6K
- **实验 id**: 294   **签名**: `14225afa880a60b2c83423b829c1fbf9f7783ed4`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T04:03:42.869407+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.90
...
- 时空块:
  0. spatial=`synth_StGraphAttnWithMpsGated_v7` temporal=`st_graph_attn` fusion=`cross` 🔬
  ...
  4. spatial=`synth_InfoBootstrapResidual` temporal=`synth_StGraphAttnWithMpsGated_v5` fusion=`cross` 🔬
  5. spatial=`gat` temporal=`synth_InfoBootstrapResidual` fusion=`residual` 🔬
