# 模型卡: darwin-st/4fd7e06d

- **数据集**: PeMS04
- **排名**: 第 92 名 / 库内 KEEP 实验
- **val MAE**: 18.52
- **val RMSE**: 30.60
- **参数量**: 194.7K
- **实验 id**: 416   **签名**: `4fd7e06de2c3aaa497ac8605ca6a3cee83f10d01`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T09:32:21.220225+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.72
...
- 时空块:
  0. spatial=`synth_StGraphAttnWithMpsGated_v17` temporal=`identity` fusion=`residual` 🔬
  ...
  5. spatial=`synth_StGraphAttnWithMpsGated_v9` temporal=`synth_InfoBootstrapResidual` fusion=`residual` 🔬
