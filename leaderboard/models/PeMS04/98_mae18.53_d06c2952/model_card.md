# 模型卡: darwin-st/d06c2952

- **数据集**: PeMS04
- **排名**: 第 98 名 / 库内 KEEP 实验
- **val MAE**: 18.53
- **val RMSE**: 30.63
- **参数量**: 199.1K
- **实验 id**: 298   **签名**: `d06c29526b2b2f2b79ac0b3496d01a5060ccfcd9`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T06:49:57.531851+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.73
...
- 时空块:
  ...
  1. spatial=`synth_StGraphAttnWithMpsGated_v11` temporal=`st_graph_attn` fusion=`cross` 🔬
