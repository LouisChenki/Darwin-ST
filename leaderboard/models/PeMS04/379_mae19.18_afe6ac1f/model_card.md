# 模型卡: darwin-st/afe6ac1f

- **数据集**: PeMS04
- **排名**: 第 379 名 / 库内 KEEP 实验
- **val MAE**: 19.18
- **val RMSE**: 31.31
- **参数量**: 233.5K
- **实验 id**: 457   **签名**: `afe6ac1f15f0c4e371281b5782adeaf33965233e`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T06:06:29.955141+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.38
...
- 时空块:
  ...
  1. spatial=`dynamic_gat` temporal=`st_graph_attn` fusion=`cross`
