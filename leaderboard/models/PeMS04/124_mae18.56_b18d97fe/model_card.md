# 模型卡: darwin-st/b18d97fe

- **数据集**: PeMS04
- **排名**: 第 124 名 / 库内 KEEP 实验
- **val MAE**: 18.56
- **val RMSE**: 30.64
- **参数量**: 227.6K
- **实验 id**: 382   **签名**: `b18d97fe25071805674d08c515d015c9c2545850`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T19:39:48.226827+00:00
...
- 时空块:
  0. spatial=`cheb` temporal=`identity` fusion=`cross`
  ...
  5. spatial=`synth_ParallelMinimalSufficiencyAttn` temporal=`synth_StGraphAttnWithMpsGated_v9` fusion=`cross` 🔬
