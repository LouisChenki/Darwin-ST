# 模型卡: darwin-st/e3b1a5e0

- **数据集**: PeMS04
- **排名**: 第 426 名 / 库内 KEEP 实验
- **val MAE**: 19.45
- **val RMSE**: 31.48
- **参数量**: 253.1K
- **实验 id**: 624   **签名**: `e3b1a5e02fc949588dd5cdfd27bcb7362f55a22e`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-05T17:22:55.538288+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.65
...
- 时空块:
  ...
  2. spatial=`adaptive` temporal=`synth_StGraphAttnWithMpsGated_v3` fusion=`cross` 🔬
...
- 身份嵌入: node=True(128) tod=False(64) dow=True(128)
