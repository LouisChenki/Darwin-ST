# 模型卡: darwin-st/a6140ba6

- **数据集**: PeMS04
- **排名**: 第 436 名 / 库内 KEEP 实验
- **val MAE**: 19.52
- **val RMSE**: 31.38
- **参数量**: 243.7K
- **实验 id**: 474   **签名**: `a6140ba6bef9369ccdfae712d97858742fe336cc`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T14:26:48.504114+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.72
