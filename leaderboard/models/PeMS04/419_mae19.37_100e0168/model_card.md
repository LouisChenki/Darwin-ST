# 模型卡: darwin-st/100e0168

- **数据集**: PeMS04
- **排名**: 第 419 名 / 库内 KEEP 实验
- **val MAE**: 19.37
- **val RMSE**: 31.47
- **参数量**: 257.0K
- **实验 id**: 68   **签名**: `100e016803953d69c31bc664a59979cc191386ec`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-25T13:55:39.793817+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.57
...
- 时空块:
  ...
  4. spatial=`dynamic_gat` temporal=`series_decomp_attn` fusion=`residual`
