# 模型卡: darwin-st/c66842a9

- **数据集**: PeMS04
- **排名**: 第 471 名 / 库内 KEEP 实验
- **val MAE**: 20.15
- **val RMSE**: 32.57
- **参数量**: 119.0K
- **实验 id**: 125   **签名**: `c66842a95501108fa48fac74c5a7d0f22726f58d`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-26T23:03:49.750129+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +2.35
