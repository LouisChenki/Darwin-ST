# 模型卡: darwin-st/52b8ac2f

- **数据集**: PeMS04
- **排名**: 第 153 名 / 库内 KEEP 实验
- **val MAE**: 18.59
- **val RMSE**: 30.62
- **参数量**: 253.9K
- **实验 id**: 265   **签名**: `52b8ac2f628e3f1cc31bd42bb22cdd7c581e57cc`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-29T14:41:10.682672+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.79
- **评测协议**: masked metric; MAE averaged over 12 horizons; split 6/2/2

## 架构

- 深度 (blocks): 7   hidden: 64   邻接: none
- 时空块:
  ...
  4. spatial=`st_graph_attn` temporal=`synth_StGraphAttnWithMpsGated_v6` fusion=`cross` 🔬
  5. spatial=`synth_StGraphAttnWithMpsGated_v4` temporal=`synth_InfoBootstrapResidual` fusion=`residual` 🔬
  6. spatial=`synth_StGraphAttnWithMpsGated_v3` temporal=`synth_StGraphAttnWithMpsGated_v3` fusion=`cross` 🔬
