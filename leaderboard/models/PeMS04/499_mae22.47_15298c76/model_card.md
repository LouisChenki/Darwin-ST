# 模型卡: darwin-st/15298c76

- **数据集**: PeMS04
- **排名**: 第 499 名 / 库内 KEEP 实验
- **val MAE**: 22.47
- **val RMSE**: 35.68
- **参数量**: 225.9K
- **实验 id**: 263   **签名**: `15298c765a003915d9d9118dec72ddc10d9c39ef`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-29T14:09:13.967664+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.67
...
- 时空块:
  0. spatial=`st_graph_attn` temporal=`st_graph_attn` fusion=`sequential_ts`
