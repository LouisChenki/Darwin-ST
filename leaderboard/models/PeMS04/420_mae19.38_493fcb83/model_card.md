# 模型卡: darwin-st/493fcb83

- **数据集**: PeMS04
- **排名**: 第 420 名 / 库内 KEEP 实验
- **val MAE**: 19.38
- **val RMSE**: 31.35
- **参数量**: 281.2K
- **实验 id**: 480   **签名**: `493fcb837409709447bb62970ceaf6cea928a7de`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T16:17:52.788391+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.58
...
- 时空块:
  0. spatial=`synth_StGraphAttnWithMpsGated_v7` temporal=`dynamic_gat` fusion=`cross` 🔬
  ...
  6. spatial=`synth_StGraphAttnWithMpsGated_v11` temporal=`synth_ParallelMinimalSufficiencyAttn` fusion=`residual` 🔬
...
### `synth_StGraphAttnWithMpsGated_v11`
- **组合方式**: gated_routed
- **源机制 (跨域)**: minimal_predictive_sufficiency
- **该算子实测 MAE**: 18.87
- **算子代码**: [`operators/synth_StGraphAttnWithMpsGated_v11.py`](operators/synth_StGraphAttnWithMpsGated_v11.py)
