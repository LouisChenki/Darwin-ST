# 模型卡: darwin-st/d050689f

- **数据集**: PeMS04
- **排名**: 第 113 名 / 库内 KEEP 实验
- **val MAE**: 18.54
- **val RMSE**: 30.60
- **参数量**: 200.7K
- **实验 id**: 300   **签名**: `d050689fca941590d96d6ac2828e3132788280d1`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T06:52:58.398632+00:00
