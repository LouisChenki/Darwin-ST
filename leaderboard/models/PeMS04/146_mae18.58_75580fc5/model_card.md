# 模型卡: darwin-st/75580fc5

- **数据集**: PeMS04
- **排名**: 第 146 名 / 库内 KEEP 实验
- **val MAE**: 18.58
- **val RMSE**: 30.64
- **参数量**: 244.4K
- **实验 id**: 384   **签名**: `75580fc55068fa39d486df206e773482cfff7abf`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T19:42:11.650146+00:00
...
- 时空块:
  ...
  5. spatial=`synth_StGraphAttnWithMpsGated_v4` temporal=`multiscale_tcn` fusion=`residual` 🔬
