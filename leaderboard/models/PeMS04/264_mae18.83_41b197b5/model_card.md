# 模型卡: darwin-st/41b197b5

- **数据集**: PeMS04
- **排名**: 第 264 名 / 库内 KEEP 实验
- **val MAE**: 18.83
- **val RMSE**: 30.90
- **参数量**: 194.4K
- **实验 id**: 230   **签名**: `41b197b5c8dcf1897d5f4cdbd63ad80c4de6db99`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-28T18:02:55.762126+00:00
...
- 时空块:
  ...
  3. spatial=`st_graph_attn` temporal=`identity` fusion=`residual`
