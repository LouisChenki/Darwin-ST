# 模型卡: darwin-st/cca97172

- **数据集**: PeMS04
- **排名**: 第 178 名 / 库内 KEEP 实验
- **val MAE**: 18.64
- **val RMSE**: 30.73
- **参数量**: 188.2K
- **实验 id**: 304   **签名**: `cca971728015248db13c50c36df0d3c3aadf401d`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T08:16:20.801873+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.84
