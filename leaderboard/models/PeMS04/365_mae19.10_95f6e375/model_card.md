# 模型卡: darwin-st/95f6e375

- **数据集**: PeMS04
- **排名**: 第 365 名 / 库内 KEEP 实验
- **val MAE**: 19.10
- **val RMSE**: 31.25
- **参数量**: 207.4K
- **实验 id**: 111   **签名**: `95f6e37571e574d14593ee59a44ef8cc6f7d8d8d`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-26T15:50:39.847989+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.30
...
- 时空块:
  0. spatial=`st_graph_attn` temporal=`st_graph_attn` fusion=`iterative`
