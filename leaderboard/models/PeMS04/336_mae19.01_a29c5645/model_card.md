# 模型卡: darwin-st/a29c5645

- **数据集**: PeMS04
- **排名**: 第 336 名 / 库内 KEEP 实验
- **val MAE**: 19.01
- **val RMSE**: 31.11
- **参数量**: 173.4K
- **实验 id**: 45   **签名**: `a29c5645d5126587be29afc7b471d72a706102fb`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-25T06:40:45.798555+00:00
...
- 时空块:
  0. spatial=`st_graph_attn` temporal=`st_separable` fusion=`cross`
