# 模型卡: darwin-st/e7cb64b8

- **数据集**: PeMS04
- **排名**: 第 501 名 / 库内 KEEP 实验
- **val MAE**: 22.53
- **val RMSE**: 35.78
- **参数量**: 196.6K
- **实验 id**: 93   **签名**: `e7cb64b86e16ed49bfbc51466512cba279beb9db`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-26T07:29:18.499543+00:00
