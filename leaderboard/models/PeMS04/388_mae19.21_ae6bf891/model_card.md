# 模型卡: darwin-st/ae6bf891

- **数据集**: PeMS04
- **排名**: 第 388 名 / 库内 KEEP 实验
- **val MAE**: 19.21
- **val RMSE**: 31.31
- **参数量**: 238.9K
- **实验 id**: 241   **签名**: `ae6bf8915435a71e2addb3bf68fec3ba0c496983`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-29T05:04:02.716705+00:00
...
- 时空块:
  ...
  6. spatial=`synth_StGraphAttnWithMpsGated` temporal=`synth_StGraphAttnWithMpsGated_v4` fusion=`residual` 🔬
