# 模型卡: darwin-st/cbd9b182

- **数据集**: PeMS04
- **排名**: 第 340 名 / 库内 KEEP 实验
- **val MAE**: 19.02
- **val RMSE**: 31.12
- **参数量**: 196.7K
- **实验 id**: 354   **签名**: `cbd9b18229586d1bd45389f8b741064ff67b6a85`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T06:50:04.204862+00:00
...
- 时空块:
  0. spatial=`synth_StGraphAttnWithMpsGated_v7` temporal=`identity` fusion=`sequential` 🔬
