# 模型卡: darwin-st/c0ab3675

- **数据集**: PeMS04
- **排名**: 第 303 名 / 库内 KEEP 实验
- **val MAE**: 18.95
- **val RMSE**: 30.99
- **参数量**: 209.5K
- **实验 id**: 446   **签名**: `c0ab3675bb6b8c0d9f5b4247a3a8bb79e79874dc`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T02:21:28.359911+00:00
...
- 时空块:
  ...
  6. spatial=`stjoint_conv` temporal=`ssm` fusion=`residual`
