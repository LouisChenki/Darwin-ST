# 模型卡: darwin-st/ea8393f2

- **数据集**: PeMS04
- **排名**: 第 132 名 / 库内 KEEP 实验
- **val MAE**: 18.57
- **val RMSE**: 30.60
- **参数量**: 186.3K
- **实验 id**: 226   **签名**: `ea8393f2d5b370a0635fbdbf7c2bd877ca29ea53`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-28T16:46:19.743231+00:00
...
- 时空块:
  0. spatial=`st_graph_attn` temporal=`synth_StGraphAttnWithMpsGated_v7` fusion=`cross` 🔬
