# 模型卡: darwin-st/0cc8e891

- **数据集**: PeMS04
- **排名**: 第 332 名 / 库内 KEEP 实验
- **val MAE**: 19.00
- **val RMSE**: 31.03
- **参数量**: 222.1K
- **实验 id**: 485   **签名**: `0cc8e8915a38cdc2b155795b92e27777affe066d`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T19:45:22.422595+00:00
...
- 时空块:
  ...
  6. spatial=`gat` temporal=`st_graph_attn` fusion=`residual`
