# 模型卡: darwin-st/887abd8b

- **数据集**: PeMS04
- **排名**: 第 451 名 / 库内 KEEP 实验
- **val MAE**: 19.69
- **val RMSE**: 31.74
- **参数量**: 266.6K
- **实验 id**: 585   **签名**: `887abd8b83289c5754f0b0769dbd12106a8272fb`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-04T20:15:16.381487+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.89
