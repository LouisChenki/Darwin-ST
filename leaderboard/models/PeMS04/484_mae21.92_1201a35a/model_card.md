# 模型卡: darwin-st/1201a35a

- **数据集**: PeMS04
- **排名**: 第 484 名 / 库内 KEEP 实验
- **val MAE**: 21.92
- **val RMSE**: 34.71
- **参数量**: 212.0K
- **实验 id**: 147   **签名**: `1201a35a48e9dbe3cbc8a7b695ca26d71c5af833`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-27T10:26:45.129681+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.12
...
- 时空块:
  ...
  5. spatial=`gat` temporal=`synth_StGraphAttnWithMpsGated_v4` fusion=`residual` 🔬
