# 模型卡: darwin-st/91c12413

- **数据集**: PeMS04
- **排名**: 第 513 名 / 库内 KEEP 实验
- **val MAE**: 22.65
- **val RMSE**: 35.80
- **参数量**: 796.0K
- **实验 id**: 470   **签名**: `91c124133a3eaa20a25652d9b26fd8dc8f431142`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T12:19:37.554286+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.85
