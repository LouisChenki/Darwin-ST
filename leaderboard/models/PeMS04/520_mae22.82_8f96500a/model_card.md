# 模型卡: darwin-st/8f96500a

- **数据集**: PeMS04
- **排名**: 第 520 名 / 库内 KEEP 实验
- **val MAE**: 22.82
- **val RMSE**: 36.13
- **参数量**: 287.3K
- **实验 id**: 504   **签名**: `8f96500a65797a057917a7fc2ce47b9c5f15de96`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-03T05:29:21.784024+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +5.02
- **评测协议**: masked metric; MAE averaged over 12 horizons; split 6/2/2

## 架构

- 深度 (blocks): 8   hidden: 64   邻接: none
- 时空块:
  ...
  7. spatial=`identity` temporal=`identity` fusion=`sequential`
