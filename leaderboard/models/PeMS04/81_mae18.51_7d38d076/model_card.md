# 模型卡: darwin-st/7d38d076

- **数据集**: PeMS04
- **排名**: 第 81 名 / 库内 KEEP 实验
- **val MAE**: 18.51
- **val RMSE**: 30.67
- **参数量**: 196.7K
- **实验 id**: 359   **签名**: `7d38d076273559e2c512d3bbc662a43150b4ae40`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T08:23:17.136914+00:00
...
- 时空块:
  0. spatial=`synth_StGraphAttnWithMpsGated_v6` temporal=`identity` fusion=`cross` 🔬
