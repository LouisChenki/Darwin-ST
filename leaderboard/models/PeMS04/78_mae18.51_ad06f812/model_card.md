# 模型卡: darwin-st/ad06f812

- **数据集**: PeMS04
- **排名**: 第 78 名 / 库内 KEEP 实验
- **val MAE**: 18.51
- **val RMSE**: 30.78
- **参数量**: 245.7K
- **实验 id**: 664   **签名**: `ad06f8125b925a45e7cc287b7752e62ca6a7579a`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-06T16:53:51.073483+00:00
...
- 时空块:
  ...
  2. spatial=`adaptive` temporal=`synth_StGraphAttnWithMpsGated_v28` fusion=`cross` 🔬
  ...
  5. spatial=`synth_StGraphAttnWithMpsGated_v2` temporal=`synth_st_graph_attn_with_vib_compression` fusion=`cross` 🔬
...
### `synth_StGraphAttnWithMpsGated_v28`
- **组合方式**: gated_routed
- **源机制 (跨域)**: minimal_predictive_sufficiency
- **该算子实测 MAE**: 18.72
- **算子代码**: [`operators/synth_StGraphAttnWithMpsGated_v28.py`](operators/synth_StGraphAttnWithMpsGated_v28.py)
