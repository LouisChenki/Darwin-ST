# 模型卡: darwin-st/83c5c000

- **数据集**: PeMS04
- **排名**: 第 151 名 / 库内 KEEP 实验
- **val MAE**: 18.58
- **val RMSE**: 30.62
- **参数量**: 249.9K
- **实验 id**: 454   **签名**: `83c5c0001d1b8c248bdfdfeb498b5e9d1974b962`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T05:27:17.197557+00:00
...
- 时空块:
  ...
  1. spatial=`synth_st_graph_attn_with_vib_compression` temporal=`st_graph_attn` fusion=`cross` 🔬
