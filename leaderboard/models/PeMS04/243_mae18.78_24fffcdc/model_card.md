# 模型卡: darwin-st/24fffcdc

- **数据集**: PeMS04
- **排名**: 第 243 名 / 库内 KEEP 实验
- **val MAE**: 18.78
- **val RMSE**: 30.86
- **参数量**: 198.9K
- **实验 id**: 417   **签名**: `24fffcdc3f6c9dfa3cb18444ab0b04fa35615f3c`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T10:43:40.701462+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.98
...
```json
{
  "lr": 0.0042240597096531215,
  "weight_decay": 1.8096248927149702e-06,
  "dropout": 0.17786027442157468,
  "batch_size": 32,
  "lr_schedule": "plateau",
  "num_heads": 2
}
