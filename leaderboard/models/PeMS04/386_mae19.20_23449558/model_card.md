# 模型卡: darwin-st/23449558

- **数据集**: PeMS04
- **排名**: 第 386 名 / 库内 KEEP 实验
- **val MAE**: 19.20
- **val RMSE**: 31.26
- **参数量**: 177.7K
- **实验 id**: 148   **签名**: `234495581f232e0f23f39e03c0fb01e263637cda`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-27T10:28:51.855722+00:00
...
- 时空块:
  ...
  4. spatial=`dynamic_gat` temporal=`identity` fusion=`sequential_ts`
