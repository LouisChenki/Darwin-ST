# 模型卡: darwin-st/cd6d3a3a

- **数据集**: PeMS04
- **排名**: 第 165 名 / 库内 KEEP 实验
- **val MAE**: 18.61
- **val RMSE**: 30.71
- **参数量**: 190.3K
- **实验 id**: 212   **签名**: `cd6d3a3ac26e1a7d0335d567ea5e9898d20c8843`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-28T11:31:10.692253+00:00
