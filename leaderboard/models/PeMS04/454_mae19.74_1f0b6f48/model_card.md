# 模型卡: darwin-st/1f0b6f48

- **数据集**: PeMS04
- **排名**: 第 454 名 / 库内 KEEP 实验
- **val MAE**: 19.74
- **val RMSE**: 31.95
- **参数量**: 240.1K
- **实验 id**: 74   **签名**: `1f0b6f483fcfd724d7237a2da83623503366162a`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-25T18:51:57.633324+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.94
...
- 时空块:
  ...
  2. spatial=`st_graph_attn` temporal=`series_decomp_attn` fusion=`cross`
