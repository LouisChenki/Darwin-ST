# 模型卡: darwin-st/07cefb81

- **数据集**: PeMS04
- **排名**: 第 89 名 / 库内 KEEP 实验
- **val MAE**: 18.52
- **val RMSE**: 30.65
- **参数量**: 254.1K
- **实验 id**: 644   **签名**: `07cefb8147328a1431df8a02d19375d0982e15b9`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-06T05:48:22.996759+00:00
...
- 时空块:
  ...
  4. spatial=`synth_InfoBootstrapResidual` temporal=`synth_StGraphAttnWithMpsGated_v22` fusion=`cross` 🔬
...
### `synth_StGraphAttnWithMpsGated_v22`
- **组合方式**: gated_routed
- **源机制 (跨域)**: minimal_predictive_sufficiency
- **该算子实测 MAE**: 18.67
- **算子代码**: [`operators/synth_StGraphAttnWithMpsGated_v22.py`](operators/synth_StGraphAttnWithMpsGated_v22.py)
