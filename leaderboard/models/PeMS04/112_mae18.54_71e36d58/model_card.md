# 模型卡: darwin-st/71e36d58

- **数据集**: PeMS04
- **排名**: 第 112 名 / 库内 KEEP 实验
- **val MAE**: 18.54
- **val RMSE**: 30.62
- **参数量**: 249.1K
- **实验 id**: 515   **签名**: `71e36d585d63d7804b1c45708687ba846e652369`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-03T11:26:42.138555+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.74
...
- 时空块:
  ...
  3. spatial=`synth_StGraphAttnWithMpsGated_v11` temporal=`identity` fusion=`cross` 🔬
  ...
  6. spatial=`dynamic_gat` temporal=`gru` fusion=`cross`
