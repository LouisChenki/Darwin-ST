# 模型卡: darwin-st/79a72ebd

- **数据集**: PeMS04
- **排名**: 第 20 名 / 库内 KEEP 实验
- **val MAE**: 18.38
- **val RMSE**: —
- **参数量**: 1.42M
- **实验 id**: 531   **签名**: `79a72ebd85ccaab0b2a8e18d969a2712818f8940`
- **run_tag**: exp/sota-24h   **时间**: 2026-06-30T21:22:46.045093+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.58
- **评测协议**: masked metric; MAE averaged over 12 horizons; split 6/2/2

## 架构

- 深度 (blocks): 4   hidden: 256   邻接: none
- 时空块:
  0. spatial=`cheb` temporal=`identity` fusion=`iterative`
...
```json
{
  "lr": 0.0020356669834169505,
  "weight_decay": 3.239497408664141e-06,
