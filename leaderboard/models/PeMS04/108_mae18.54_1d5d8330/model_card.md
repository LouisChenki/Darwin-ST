# 模型卡: darwin-st/1d5d8330

- **数据集**: PeMS04
- **排名**: 第 108 名 / 库内 KEEP 实验
- **val MAE**: 18.54
- **val RMSE**: 30.55
- **参数量**: 220.5K
- **实验 id**: 582   **签名**: `1d5d833000ee6b3c8c565bb625dc539531413f88`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-04T19:14:20.026866+00:00
...
- 时空块:
  0. spatial=`synth_StGraphAttnWithMpsGated_v7` temporal=`identity` fusion=`residual` 🔬
