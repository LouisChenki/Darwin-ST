# 模型卡: darwin-st/beb0bc22

- **数据集**: PeMS04
- **排名**: 第 404 名 / 库内 KEEP 实验
- **val MAE**: 19.28
- **val RMSE**: 31.43
- **参数量**: 513.4K
- **实验 id**: 32   **签名**: `beb0bc223f1f30da6ce9203abcd9cdc965818f56`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-25T02:16:26.648383+00:00
...
- 时空块:
  ...
  1. spatial=`identity` temporal=`st_graph_attn` fusion=`cross`
