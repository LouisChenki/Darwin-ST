# 模型卡: darwin-st/17b9ba44

- **数据集**: PeMS04
- **排名**: 第 522 名 / 库内 KEEP 实验
- **val MAE**: 22.84
- **val RMSE**: 36.14
- **参数量**: 227.9K
- **实验 id**: 387   **签名**: `17b9ba4441a789db07935faf944389c307e07e48`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T21:22:41.222410+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +5.04
...
- 时空块:
  ...
  5. spatial=`synth_ParallelMinimalSufficiencyAttn` temporal=`synth_StGraphAttnWithMpsGated_v9` fusion=`residual` 🔬
