# 模型卡: darwin-st/2377fc5e

- **数据集**: PeMS04
- **排名**: 第 511 名 / 库内 KEEP 实验
- **val MAE**: 22.63
- **val RMSE**: 35.82
- **参数量**: 177.7K
- **实验 id**: 181   **签名**: `2377fc5e6bbb85650b621a674cfd265989381b31`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-27T23:41:50.848682+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.83
...
- 时空块:
  0. spatial=`gat` temporal=`st_graph_attn` fusion=`residual`
