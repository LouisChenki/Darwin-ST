# 模型卡: darwin-st/e44185de

- **数据集**: PeMS04
- **排名**: 第 152 名 / 库内 KEEP 实验
- **val MAE**: 18.58
- **val RMSE**: 30.65
- **参数量**: 237.2K
- **实验 id**: 271   **签名**: `e44185de28137bdcf548d21149a6272db37b4781`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-29T17:48:31.745983+00:00
...
- 时空块:
  ...
  3. spatial=`synth_StGraphAttnWithMpsGated_v6` temporal=`identity` fusion=`cross` 🔬
