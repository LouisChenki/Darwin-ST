# 模型卡: darwin-st/98a71e85

- **数据集**: PeMS04
- **排名**: 第 128 名 / 库内 KEEP 实验
- **val MAE**: 18.56
- **val RMSE**: 30.65
- **参数量**: 255.9K
- **实验 id**: 660   **签名**: `98a71e85b00b228ea91ddfa8f7e3db0312ec3885`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-06T15:15:54.712224+00:00
...
- 时空块:
  ...
  5. spatial=`synth_StGraphAttnWithMpsGated_v4` temporal=`synth_StGraphAttnWithMpsGated_v21` fusion=`residual` 🔬
