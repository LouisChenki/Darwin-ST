# 模型卡: darwin-st/3ee5759f

- **数据集**: PeMS04
- **排名**: 第 373 名 / 库内 KEEP 实验
- **val MAE**: 19.15
- **val RMSE**: 31.30
- **参数量**: 177.4K
- **实验 id**: 54   **签名**: `3ee5759f71769e0299ef72e609594118fdab9890`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-25T09:17:47.244101+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.35
...
- 时空块:
  ...
  2. spatial=`mixhop` temporal=`stjoint_conv` fusion=`parallel`
