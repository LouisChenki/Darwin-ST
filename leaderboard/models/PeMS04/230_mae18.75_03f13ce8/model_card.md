# 模型卡: darwin-st/03f13ce8

- **数据集**: PeMS04
- **排名**: 第 230 名 / 库内 KEEP 实验
- **val MAE**: 18.75
- **val RMSE**: 30.69
- **参数量**: 201.3K
- **实验 id**: 594   **签名**: `03f13ce8f26368041aef00d8a8eeecd656a8e280`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-05T03:01:44.113271+00:00
...
- 时空块:
  ...
  1. spatial=`st_separable` temporal=`st_graph_attn` fusion=`residual`
...
- 身份嵌入: node=True(64) tod=True(64) dow=True(128)
