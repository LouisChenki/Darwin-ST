# 模型卡: darwin-st/abd28326

- **数据集**: PeMS04
- **排名**: 第 194 名 / 库内 KEEP 实验
- **val MAE**: 18.67
- **val RMSE**: 30.78
- **参数量**: 213.6K
- **实验 id**: 253   **签名**: `abd28326dec99c9cd519a8b85800f27d715499a1`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-29T10:29:50.909503+00:00
...
- 时空块:
  ...
  4. spatial=`synth_InfoBootstrapResidual` temporal=`synth_StGraphAttnWithMpsGated_v6` fusion=`parallel` 🔬
