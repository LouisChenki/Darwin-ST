# 模型卡: darwin-st/5204fd08

- **数据集**: PeMS04
- **排名**: 第 145 名 / 库内 KEEP 实验
- **val MAE**: 18.58
- **val RMSE**: 30.69
- **参数量**: 234.8K
- **实验 id**: 281   **签名**: `5204fd082e8880b1b900a4db8b8e8da8b6dfea4c`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-29T22:19:03.289425+00:00
...
- 时空块:
  ...
  6. spatial=`synth_StGraphAttnWithMpsGated_v4` temporal=`identity` fusion=`iterative` 🔬
