# 模型卡: darwin-st/df231750

- **数据集**: PeMS04
- **排名**: 第 297 名 / 库内 KEEP 实验
- **val MAE**: 18.92
- **val RMSE**: 31.01
- **参数量**: 209.1K
- **实验 id**: 425   **签名**: `df2317500c95bf265d362f06944e2e8908a254f4`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T14:15:56.364765+00:00
...
- 时空块:
  ...
  3. spatial=`dynamic_gat` temporal=`gru` fusion=`cross`
