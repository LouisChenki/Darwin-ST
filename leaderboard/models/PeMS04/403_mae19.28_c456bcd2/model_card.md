# 模型卡: darwin-st/c456bcd2

- **数据集**: PeMS04
- **排名**: 第 403 名 / 库内 KEEP 实验
- **val MAE**: 19.28
- **val RMSE**: 31.42
- **参数量**: 149.1K
- **实验 id**: 146   **签名**: `c456bcd286dba39329052d2605a4c2d090faa81f`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-27T09:55:42.915979+00:00
...
- 时空块:
  ...
  3. spatial=`gat` temporal=`series_decomp_attn` fusion=`parallel`
