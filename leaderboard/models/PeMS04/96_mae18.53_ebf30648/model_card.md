# 模型卡: darwin-st/ebf30648

- **数据集**: PeMS04
- **排名**: 第 96 名 / 库内 KEEP 实验
- **val MAE**: 18.53
- **val RMSE**: 30.63
- **参数量**: 293.6K
- **实验 id**: 685   **签名**: `ebf30648da86678e69563a32fdfd6677b052f18b`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-07T02:41:32.749118+00:00
...
- 时空块:
  ...
  7. spatial=`stjoint_conv` temporal=`synth_InfoBootstrapResidual` fusion=`parallel` 🔬
