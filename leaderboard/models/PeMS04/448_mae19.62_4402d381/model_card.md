# 模型卡: darwin-st/4402d381

- **数据集**: PeMS04
- **排名**: 第 448 名 / 库内 KEEP 实验
- **val MAE**: 19.62
- **val RMSE**: 31.57
- **参数量**: 165.4K
- **实验 id**: 224   **签名**: `4402d381e5b2ffa6e732aa4765efe27ead34023c`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-28T15:44:39.752647+00:00
...
- 时空块:
  ...
  3. spatial=`st_separable` temporal=`dynamic_gat` fusion=`cross`
- 身份嵌入: node=True(64) tod=False(32) dow=True(64)
