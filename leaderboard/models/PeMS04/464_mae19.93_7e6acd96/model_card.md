# 模型卡: darwin-st/7e6acd96

- **数据集**: PeMS04
- **排名**: 第 464 名 / 库内 KEEP 实验
- **val MAE**: 19.93
- **val RMSE**: 32.12
- **参数量**: 173.0K
- **实验 id**: 299   **签名**: `7e6acd96884299b564dd660788a79987bb780029`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T06:51:27.474007+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +2.13
