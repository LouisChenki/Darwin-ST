# 模型卡: darwin-st/92f657d1

- **数据集**: PeMS04
- **排名**: 第 227 名 / 库内 KEEP 实验
- **val MAE**: 18.74
- **val RMSE**: 30.86
- **参数量**: 161.2K
- **实验 id**: 349   **签名**: `92f657d19755d42e47e01a0324f9ecdb4dba19ba`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T03:21:26.740887+00:00
...
- 时空块:
  ...
  4. spatial=`identity` temporal=`synth_InfoBootstrapResidual` fusion=`residual` 🔬
