# 模型卡: darwin-st/b93f657d

- **数据集**: PeMS04
- **排名**: 第 252 名 / 库内 KEEP 实验
- **val MAE**: 18.80
- **val RMSE**: 30.88
- **参数量**: 268.6K
- **实验 id**: 527   **签名**: `b93f657dc3e86831d6a61a9edb369f40ca76a357`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-03T16:44:05.351573+00:00
...
- 时空块:
  ...
  1. spatial=`st_separable` temporal=`synth_StGraphAttnWithMpsGated_v5` fusion=`cross` 🔬
