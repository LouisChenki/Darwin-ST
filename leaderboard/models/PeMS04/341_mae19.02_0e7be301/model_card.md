# 模型卡: darwin-st/0e7be301

- **数据集**: PeMS04
- **排名**: 第 341 名 / 库内 KEEP 实验
- **val MAE**: 19.02
- **val RMSE**: 31.05
- **参数量**: 244.4K
- **实验 id**: 393   **签名**: `0e7be301463ea3c84cd0c2ca89034e83719511b9`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T23:57:35.268429+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.22
...
- 时空块:
  ...
  5. spatial=`synth_StGraphAttnWithMpsGated_v6` temporal=`multiscale_tcn` fusion=`residual` 🔬
