# 模型卡: darwin-st/d5088d3c

- **数据集**: PeMS04
- **排名**: 第 255 名 / 库内 KEEP 实验
- **val MAE**: 18.81
- **val RMSE**: 30.93
- **参数量**: 211.8K
- **实验 id**: 118   **签名**: `d5088d3c04b86e579c6ac6b0c7098558b71d0b39`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-26T18:24:07.947343+00:00
...
- 时空块:
  ...
  2. spatial=`st_graph_attn` temporal=`synth_StGraphAttnWithMpsGated_v3` fusion=`cross` 🔬
