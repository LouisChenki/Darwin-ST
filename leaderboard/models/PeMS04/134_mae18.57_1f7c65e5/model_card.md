# 模型卡: darwin-st/1f7c65e5

- **数据集**: PeMS04
- **排名**: 第 134 名 / 库内 KEEP 实验
- **val MAE**: 18.57
- **val RMSE**: 30.63
- **参数量**: 268.3K
- **实验 id**: 573   **签名**: `1f7c65e5390cedaac463c7a92fa66dc1a0d42e6f`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-04T14:28:37.236780+00:00
...
- 时空块:
  ...
  4. spatial=`st_separable` temporal=`stjoint_conv` fusion=`cross`
