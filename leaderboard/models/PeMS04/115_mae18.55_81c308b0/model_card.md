# 模型卡: darwin-st/81c308b0

- **数据集**: PeMS04
- **排名**: 第 115 名 / 库内 KEEP 实验
- **val MAE**: 18.55
- **val RMSE**: 30.60
- **参数量**: 207.2K
- **实验 id**: 403   **签名**: `81c308b041c05a40d07d2015fe03302503370e56`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T03:58:33.408341+00:00
...
- 时空块:
  ...
  5. spatial=`synth_StGraphAttnWithMpsGated_v4` temporal=`series_decomp_attn` fusion=`residual` 🔬
