# 模型卡: darwin-st/21752202

- **数据集**: PeMS04
- **排名**: 第 257 名 / 库内 KEEP 实验
- **val MAE**: 18.81
- **val RMSE**: 30.89
- **参数量**: 230.7K
- **实验 id**: 361   **签名**: `2175220296c4f1a4fb135ea97cf8907cefc8a5bf`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T08:37:36.175072+00:00
...
- 时空块:
  ...
  3. spatial=`dynamic_gat` temporal=`synth_StGraphAttnWithMpsGated_v13` fusion=`cross` 🔬
