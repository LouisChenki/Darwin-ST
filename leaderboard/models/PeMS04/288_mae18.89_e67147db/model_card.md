# 模型卡: darwin-st/e67147db

- **数据集**: PeMS04
- **排名**: 第 288 名 / 库内 KEEP 实验
- **val MAE**: 18.89
- **val RMSE**: 30.89
- **参数量**: 144.2K
- **实验 id**: 192   **签名**: `e67147db3a9119c90e3dc5e80d35f21d8443f771`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-28T04:42:05.885419+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.09
...
- 时空块:
  ...
  1. spatial=`gwnet_adp` temporal=`st_separable` fusion=`cross`
  2. spatial=`synth_InfoBootstrapResidual` temporal=`stjoint_conv` fusion=`parallel` 🔬
