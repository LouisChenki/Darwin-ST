# 模型卡: darwin-st/c3faf42d

- **数据集**: PeMS04
- **排名**: 第 238 名 / 库内 KEEP 实验
- **val MAE**: 18.77
- **val RMSE**: 30.89
- **参数量**: 211.4K
- **实验 id**: 661   **签名**: `c3faf42d9e912e603eeb7538c715ae278fab85cd`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-06T15:55:00.401912+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.97
...
- 时空块:
  ...
  2. spatial=`stjoint_conv` temporal=`st_separable` fusion=`cross`
