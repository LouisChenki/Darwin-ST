# 模型卡: darwin-st/474d9bbb

- **数据集**: PeMS04
- **排名**: 第 254 名 / 库内 KEEP 实验
- **val MAE**: 18.80
- **val RMSE**: 30.94
- **参数量**: 273.0K
- **实验 id**: 689   **签名**: `474d9bbbd646c171f7ca94eeb177925a8d95de15`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-07T07:05:00.185165+00:00
...
```json
{
  "lr": 0.002067277653611576,
  "weight_decay": 1.2255979669854195e-06,
  "dropout": 0.23989723852737724,
  "batch_size": 16,
  "lr_schedule": "cosine",
  "num_heads": 1
}
