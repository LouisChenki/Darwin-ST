# 模型卡: darwin-st/d63688ae

- **数据集**: PeMS04
- **排名**: 第 45 名 / 库内 KEEP 实验
- **val MAE**: 18.48
- **val RMSE**: 30.54
- **参数量**: 230.0K
- **实验 id**: 631   **签名**: `d63688aee326bd8f58418dfa5f7dd2f7d39b2f8f`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-05T23:09:40.523299+00:00
...
- 时空块:
  ...
  3. spatial=`synth_StGraphAttnWithMpsGated_v2` temporal=`identity` fusion=`cross` 🔬
