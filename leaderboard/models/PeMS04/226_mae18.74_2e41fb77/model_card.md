# 模型卡: darwin-st/2e41fb77

- **数据集**: PeMS04
- **排名**: 第 226 名 / 库内 KEEP 实验
- **val MAE**: 18.74
- **val RMSE**: 30.77
- **参数量**: 287.0K
- **实验 id**: 629   **签名**: `2e41fb77a74e46b07356b443675ceca63c13bd44`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-05T21:38:19.563943+00:00
...
- 时空块:
  ...
  3. spatial=`dynamic_gat` temporal=`multiscale_tcn` fusion=`cross`
