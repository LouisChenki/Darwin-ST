# 模型卡: darwin-st/a049010d

- **数据集**: PeMS04
- **排名**: 第 298 名 / 库内 KEEP 实验
- **val MAE**: 18.92
- **val RMSE**: 30.99
- **参数量**: 177.7K
- **实验 id**: 155   **签名**: `a049010d6899d72f3955cb349eefc2677e6ceed6`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-27T13:14:40.477187+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.12
...
- 时空块:
  0. spatial=`cheb` temporal=`st_graph_attn` fusion=`cross`
