# 模型卡: darwin-st/45bfd6fd

- **数据集**: PeMS04
- **排名**: 第 378 名 / 库内 KEEP 实验
- **val MAE**: 19.17
- **val RMSE**: 31.24
- **参数量**: 215.6K
- **实验 id**: 269   **签名**: `45bfd6fde682dab5840e7a4edf7e4b03e4abb06a`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-29T16:31:30.913561+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.37
