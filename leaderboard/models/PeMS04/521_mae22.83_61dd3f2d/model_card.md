# 模型卡: darwin-st/61dd3f2d

- **数据集**: PeMS04
- **排名**: 第 521 名 / 库内 KEEP 实验
- **val MAE**: 22.83
- **val RMSE**: 36.17
- **参数量**: 718.5K
- **实验 id**: 535   **签名**: `61dd3f2d79a642dfd955e50f30baef317f1d274a`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-03T20:57:12.331160+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +5.03
