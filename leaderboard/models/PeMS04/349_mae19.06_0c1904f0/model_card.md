# 模型卡: darwin-st/0c1904f0

- **数据集**: PeMS04
- **排名**: 第 349 名 / 库内 KEEP 实验
- **val MAE**: 19.06
- **val RMSE**: 31.10
- **参数量**: 233.3K
- **实验 id**: 687   **签名**: `0c1904f0565e9cd8ab71eb6f5093b26d3347afd5`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-07T04:23:52.532324+00:00
...
- 时空块:
  ...
  1. spatial=`synth_StGraphAttnWithMpsGated_v32` temporal=`ssm` fusion=`cross` 🔬
