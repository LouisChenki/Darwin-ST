# 模型卡: darwin-st/9382c832

- **数据集**: PeMS04
- **排名**: 第 136 名 / 库内 KEEP 实验
- **val MAE**: 18.57
- **val RMSE**: 30.61
- **参数量**: 219.8K
- **实验 id**: 351   **签名**: `9382c8320fc901cbff6b4811d5d86431de92a224`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T04:39:01.996465+00:00
...
- 时空块:
  ...
  6. spatial=`gwnet_adp` temporal=`synth_StGraphAttnWithMpsGated_v6` fusion=`cross` 🔬
