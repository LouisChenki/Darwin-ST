# 模型卡: darwin-st/9ae8f362

- **数据集**: PeMS04
- **排名**: 第 266 名 / 库内 KEEP 实验
- **val MAE**: 18.83
- **val RMSE**: 30.87
- **参数量**: 262.2K
- **实验 id**: 489   **签名**: `9ae8f362594cfa9531c833caee5fabe51fb4c711`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T22:10:17.505218+00:00
...
- 时空块:
  ...
  1. spatial=`st_separable` temporal=`st_graph_attn` fusion=`parallel`
