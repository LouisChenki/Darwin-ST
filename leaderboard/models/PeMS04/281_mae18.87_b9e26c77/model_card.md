# 模型卡: darwin-st/b9e26c77

- **数据集**: PeMS04
- **排名**: 第 281 名 / 库内 KEEP 实验
- **val MAE**: 18.87
- **val RMSE**: 30.97
- **参数量**: 209.6K
- **实验 id**: 412   **签名**: `b9e26c775d30b551679de6d455b2225de5aed51c`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T08:08:10.034836+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.07
...
- 时空块:
  ...
  6. spatial=`identity` temporal=`synth_StGraphAttnWithMpsGated_v18` fusion=`parallel` 🔬
