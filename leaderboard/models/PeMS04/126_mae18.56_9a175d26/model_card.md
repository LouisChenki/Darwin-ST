# 模型卡: darwin-st/9a175d26

- **数据集**: PeMS04
- **排名**: 第 126 名 / 库内 KEEP 实验
- **val MAE**: 18.56
- **val RMSE**: 30.58
- **参数量**: 264.8K
- **实验 id**: 680   **签名**: `9a175d26f45de74f05cb3c1a4e99ea6971d54d05`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-06T23:44:09.382103+00:00
...
- 时空块:
  ...
  3. spatial=`synth_StGraphAttnWithMpsGated_v19` temporal=`ssm` fusion=`cross` 🔬
