# 模型卡: darwin-st/fe76b766

- **数据集**: PeMS04
- **排名**: 第 195 名 / 库内 KEEP 实验
- **val MAE**: 18.67
- **val RMSE**: 30.70
- **参数量**: 186.3K
- **实验 id**: 203   **签名**: `fe76b766b45c21b42c642779d12855c7d832e428`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-28T08:56:23.839549+00:00
...
- 时空块:
  0. spatial=`st_graph_attn` temporal=`synth_StGraphAttnWithMpsGated_v4` fusion=`cross` 🔬
