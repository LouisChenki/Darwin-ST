# 模型卡: darwin-st/153f8fc4

- **数据集**: PeMS04
- **排名**: 第 510 名 / 库内 KEEP 实验
- **val MAE**: 22.62
- **val RMSE**: 35.79
- **参数量**: 252.4K
- **实验 id**: 502   **签名**: `153f8fc4d49e0752d437c94ba95fa6410e12603e`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-03T04:57:05.852462+00:00
...
- 时空块:
  ...
  6. spatial=`st_graph_attn` temporal=`attn` fusion=`sequential_ts`
