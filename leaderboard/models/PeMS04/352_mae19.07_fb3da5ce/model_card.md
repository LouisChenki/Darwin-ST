# 模型卡: darwin-st/fb3da5ce

- **数据集**: PeMS04
- **排名**: 第 352 名 / 库内 KEEP 实验
- **val MAE**: 19.07
- **val RMSE**: 31.30
- **参数量**: 266.3K
- **实验 id**: 526   **签名**: `fb3da5ce0a6dd796b15a033c18214f7d099cccfb`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-03T16:18:18.471711+00:00
...
- 时空块:
  ...
  3. spatial=`gwnet_adp` temporal=`identity` fusion=`cross`
