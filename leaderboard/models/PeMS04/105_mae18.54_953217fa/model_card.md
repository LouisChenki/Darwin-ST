# 模型卡: darwin-st/953217fa

- **数据集**: PeMS04
- **排名**: 第 105 名 / 库内 KEEP 实验
- **val MAE**: 18.54
- **val RMSE**: 30.60
- **参数量**: 215.3K
- **实验 id**: 407   **签名**: `953217fa298d75754248b3c3511f912084e3b88f`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T05:51:32.538784+00:00
...
- 时空块:
  0. spatial=`adaptive` temporal=`st_graph_attn` fusion=`cross`
