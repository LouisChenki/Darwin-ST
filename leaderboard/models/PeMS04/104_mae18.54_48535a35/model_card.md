# 模型卡: darwin-st/48535a35

- **数据集**: PeMS04
- **排名**: 第 104 名 / 库内 KEEP 实验
- **val MAE**: 18.54
- **val RMSE**: 30.63
- **参数量**: 240.3K
- **实验 id**: 272   **签名**: `48535a352ba9accac4be77d9fed4fe54a2955279`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-29T17:49:03.484880+00:00
...
- 时空块:
  ...
  5. spatial=`synth_StGraphAttnWithMpsGated_v4` temporal=`synth_st_graph_attn_with_vib_compression` fusion=`residual` 🔬
