# 模型卡: darwin-st/f648cb1d

- **数据集**: PeMS04
- **排名**: 第 59 名 / 库内 KEEP 实验
- **val MAE**: 18.49
- **val RMSE**: 30.64
- **参数量**: 230.7K
- **实验 id**: 477   **签名**: `f648cb1de60e52aac061f46b4e8c4c78e39255fb`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T14:45:55.709565+00:00
...
- 时空块:
  0. spatial=`gwnet_adp` temporal=`dynamic_gat` fusion=`cross`
