# 模型卡: darwin-st/4867c2d1

- **数据集**: PeMS04
- **排名**: 第 150 名 / 库内 KEEP 实验
- **val MAE**: 18.58
- **val RMSE**: 30.77
- **参数量**: 258.3K
- **实验 id**: 640   **签名**: `4867c2d1632218765b299bd7b70c253adc9f292e`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-06T02:18:35.199741+00:00
...
- 时空块:
  ...
  6. spatial=`synth_StGraphAttnWithMpsGated_v2` temporal=`synth_StGraphAttnWithMpsGated_v15` fusion=`cross` 🔬
