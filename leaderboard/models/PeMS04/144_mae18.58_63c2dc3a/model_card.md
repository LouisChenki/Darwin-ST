# 模型卡: darwin-st/63c2dc3a

- **数据集**: PeMS04
- **排名**: 第 144 名 / 库内 KEEP 实验
- **val MAE**: 18.58
- **val RMSE**: 30.64
- **参数量**: 238.6K
- **实验 id**: 345   **签名**: `63c2dc3a2b2f002253b3176ffe4f24a85c672f40`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T02:25:21.207575+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.78
...
- 时空块:
  ...
  6. spatial=`stjoint_conv` temporal=`tcn` fusion=`cross`
