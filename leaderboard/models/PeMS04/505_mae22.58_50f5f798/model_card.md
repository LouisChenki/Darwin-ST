# 模型卡: darwin-st/50f5f798

- **数据集**: PeMS04
- **排名**: 第 505 名 / 库内 KEEP 实验
- **val MAE**: 22.58
- **val RMSE**: 35.78
- **参数量**: 239.0K
- **实验 id**: 251   **签名**: `50f5f79880af7074c674f3b54e66f02e5e8bf38f`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-29T09:39:10.734655+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.78
...
- 时空块:
  ...
  6. spatial=`synth_StGraphAttnWithMpsGated_v4` temporal=`synth_StGraphAttnWithMpsGated_v6` fusion=`sequential` 🔬
