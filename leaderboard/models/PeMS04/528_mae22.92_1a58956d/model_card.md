# 模型卡: darwin-st/1a58956d

- **数据集**: PeMS04
- **排名**: 第 528 名 / 库内 KEEP 实验
- **val MAE**: 22.92
- **val RMSE**: 36.31
- **参数量**: 726.5K
- **实验 id**: 390   **签名**: `1a58956d5b3bbb13720853ab972a075534712894`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T22:46:32.885947+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +5.12
