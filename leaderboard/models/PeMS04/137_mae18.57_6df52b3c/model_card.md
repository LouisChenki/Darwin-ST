# 模型卡: darwin-st/6df52b3c

- **数据集**: PeMS04
- **排名**: 第 137 名 / 库内 KEEP 实验
- **val MAE**: 18.57
- **val RMSE**: 30.65
- **参数量**: 262.6K
- **实验 id**: 599   **签名**: `6df52b3c49c852614520cc430fc4083c2a29ef4a`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-05T04:53:01.112240+00:00
...
- 时空块:
  0. spatial=`synth_StGraphAttnWithMpsGated_v7` temporal=`ssm` fusion=`cross` 🔬
