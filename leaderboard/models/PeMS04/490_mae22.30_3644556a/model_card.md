# 模型卡: darwin-st/3644556a

- **数据集**: PeMS04
- **排名**: 第 490 名 / 库内 KEEP 实验
- **val MAE**: 22.30
- **val RMSE**: 35.35
- **参数量**: 230.0K
- **实验 id**: 316   **签名**: `3644556a5fdb0388e439e4df7df1978d40347152`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T14:17:48.635941+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.50
