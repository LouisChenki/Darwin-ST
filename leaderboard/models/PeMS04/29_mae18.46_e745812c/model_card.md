# 模型卡: darwin-st/e745812c

- **数据集**: PeMS04
- **排名**: 第 29 名 / 库内 KEEP 实验
- **val MAE**: 18.46
- **val RMSE**: 30.51
- **参数量**: 262.2K
- **实验 id**: 487   **签名**: `e745812c489055ef6267a218f37acfc798a458fd`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T21:03:27.099971+00:00
