# 模型卡: darwin-st/d70b8d57

- **数据集**: PeMS04
- **排名**: 第 516 名 / 库内 KEEP 实验
- **val MAE**: 22.75
- **val RMSE**: 36.11
- **参数量**: 270.9K
- **实验 id**: 684   **签名**: `d70b8d57efec1ca048f74403b6b82d6d4a4a449d`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-07T00:55:21.910194+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.95
...
- 时空块:
  ...
  1. spatial=`st_separable` temporal=`synth_StGraphAttnWithMpsGated_v24` fusion=`cross` 🔬
  2. spatial=`adaptive` temporal=`st_separable` fusion=`cross`
  3. spatial=`dynamic_gat` temporal=`ssm` fusion=`cross`
