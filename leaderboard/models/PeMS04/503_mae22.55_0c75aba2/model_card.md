# 模型卡: darwin-st/0c75aba2

- **数据集**: PeMS04
- **排名**: 第 503 名 / 库内 KEEP 实验
- **val MAE**: 22.55
- **val RMSE**: 35.80
- **参数量**: 209.5K
- **实验 id**: 347   **签名**: `0c75aba2544284e75f0d2bd1a46421481cd9631a`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T03:13:55.916919+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.75
...
- 时空块:
  ...
  6. spatial=`identity` temporal=`identity` fusion=`cross`
