# 模型卡: darwin-st/3fac89f2

- **数据集**: PeMS04
- **排名**: 第 56 名 / 库内 KEEP 实验
- **val MAE**: 18.48
- **val RMSE**: 30.61
- **参数量**: 279.0K
- **实验 id**: 575   **签名**: `3fac89f2afc21490b67b509df7c493fbb813cb6a`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-04T15:57:21.824511+00:00
...
- 时空块:
  0. spatial=`synth_StGraphAttnWithMpsGated_v7` temporal=`series_decomp_attn` fusion=`residual` 🔬
