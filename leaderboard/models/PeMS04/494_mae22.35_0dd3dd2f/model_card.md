# 模型卡: darwin-st/0dd3dd2f

- **数据集**: PeMS04
- **排名**: 第 494 名 / 库内 KEEP 实验
- **val MAE**: 22.35
- **val RMSE**: 35.49
- **参数量**: 281.0K
- **实验 id**: 587   **签名**: `0dd3dd2faf4c3f1f559aef3265587046239c9576`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-04T21:07:09.635773+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.55
...
- 时空块:
  ...
  7. spatial=`cheb` temporal=`synth_InfoBootstrapResidual` fusion=`sequential` 🔬
