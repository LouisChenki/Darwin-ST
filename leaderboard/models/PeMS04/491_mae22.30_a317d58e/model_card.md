# 模型卡: darwin-st/a317d58e

- **数据集**: PeMS04
- **排名**: 第 491 名 / 库内 KEEP 实验
- **val MAE**: 22.30
- **val RMSE**: 35.49
- **参数量**: 268.6K
- **实验 id**: 490   **签名**: `a317d58ea5050e24f8892957707dd8cc17fc40f2`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T22:58:10.644681+00:00
...
- 时空块:
  ...
  7. spatial=`identity` temporal=`identity` fusion=`cross`
