# 模型卡: darwin-st/5a6f3166

- **数据集**: PeMS04
- **排名**: 第 526 名 / 库内 KEEP 实验
- **val MAE**: 22.87
- **val RMSE**: 36.15
- **参数量**: 241.3K
- **实验 id**: 398   **签名**: `5a6f31665843dc550cc97bd0f93b55184ea2d187`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T02:12:17.794871+00:00
...
- 时空块:
  ...
  2. spatial=`adaptive` temporal=`st_separable` fusion=`parallel`
