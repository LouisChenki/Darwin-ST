# 模型卡: darwin-st/f159c89e

- **数据集**: PeMS04
- **排名**: 第 367 名 / 库内 KEEP 实验
- **val MAE**: 19.11
- **val RMSE**: 31.23
- **参数量**: 774.1K
- **实验 id**: 208   **签名**: `f159c89e912537903dfce0b7f13878a7467b21bd`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-28T10:33:15.567141+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.31
- **评测协议**: masked metric; MAE averaged over 12 horizons; split 6/2/2

## 架构

- 深度 (blocks): 3   hidden: 192   邻接: none
- 时空块:
  0. spatial=`st_graph_attn` temporal=`st_graph_attn` fusion=`cross`
  1. spatial=`st_graph_attn` temporal=`st_separable` fusion=`cross`
  2. spatial=`gat` temporal=`synth_StGraphAttnWithMpsGated_v3` fusion=`iterative` 🔬
