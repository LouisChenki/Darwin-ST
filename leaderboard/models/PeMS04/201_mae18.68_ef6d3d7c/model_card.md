# 模型卡: darwin-st/ef6d3d7c

- **数据集**: PeMS04
- **排名**: 第 201 名 / 库内 KEEP 实验
- **val MAE**: 18.68
- **val RMSE**: 30.81
- **参数量**: 277.1K
- **实验 id**: 517   **签名**: `ef6d3d7c29927e0e18a5935423d15c61fe1d062b`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-03T11:33:17.851754+00:00
...
- 时空块:
  ...
  6. spatial=`synth_StGraphAttnWithMpsGated_v2` temporal=`synth_StGraphAttnWithMpsGated_v8` fusion=`cross` 🔬
  7. spatial=`adaptive` temporal=`synth_StGraphAttnWithMpsGated_v4` fusion=`residual` 🔬
