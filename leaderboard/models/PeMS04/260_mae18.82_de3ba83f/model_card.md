# 模型卡: darwin-st/de3ba83f

- **数据集**: PeMS04
- **排名**: 第 260 名 / 库内 KEEP 实验
- **val MAE**: 18.82
- **val RMSE**: 30.94
- **参数量**: 242.3K
- **实验 id**: 434   **签名**: `de3ba83f265a3401e3ac497255e8bfe798fd007e`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T20:37:16.971387+00:00
...
- 时空块:
  ...
  2. spatial=`synth_StGraphAttnWithMpsGated_v8` temporal=`st_separable` fusion=`cross` 🔬
