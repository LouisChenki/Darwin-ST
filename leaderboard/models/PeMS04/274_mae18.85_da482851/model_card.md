# 模型卡: darwin-st/da482851

- **数据集**: PeMS04
- **排名**: 第 274 名 / 库内 KEEP 实验
- **val MAE**: 18.85
- **val RMSE**: 30.95
- **参数量**: 234.2K
- **实验 id**: 186   **签名**: `da482851d5ba21a97c46dbde58508b9e1455e178`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-28T02:41:38.909909+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.05
...
- 时空块:
  ...
  1. spatial=`st_separable` temporal=`synth_InfoBootstrapResidual` fusion=`cross` 🔬
