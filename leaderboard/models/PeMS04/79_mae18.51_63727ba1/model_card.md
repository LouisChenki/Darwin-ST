# 模型卡: darwin-st/63727ba1

- **数据集**: PeMS04
- **排名**: 第 79 名 / 库内 KEEP 实验
- **val MAE**: 18.51
- **val RMSE**: 30.55
- **参数量**: 186.2K
- **实验 id**: 237   **签名**: `63727ba1c1fee6560b105e9c1ea9529f41bbec4f`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-28T21:12:48.485213+00:00
...
- 时空块:
  0. spatial=`st_graph_attn` temporal=`dynamic_gat` fusion=`cross`
