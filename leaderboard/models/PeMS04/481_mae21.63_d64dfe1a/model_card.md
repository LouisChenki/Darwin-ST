# 模型卡: darwin-st/d64dfe1a

- **数据集**: PeMS04
- **排名**: 第 481 名 / 库内 KEEP 实验
- **val MAE**: 21.63
- **val RMSE**: 34.52
- **参数量**: 188.2K
- **实验 id**: 319   **签名**: `d64dfe1a0ae5decd79e8589fbe41892292bc533a`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T15:38:30.182960+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +3.83
