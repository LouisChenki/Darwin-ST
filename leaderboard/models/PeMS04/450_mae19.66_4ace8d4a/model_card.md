# 模型卡: darwin-st/4ace8d4a

- **数据集**: PeMS04
- **排名**: 第 450 名 / 库内 KEEP 实验
- **val MAE**: 19.66
- **val RMSE**: 31.67
- **参数量**: 602.7K
- **实验 id**: 378   **签名**: `4ace8d4a7361a4722296ec2484008b7386d816dd`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T17:16:06.242077+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.86
