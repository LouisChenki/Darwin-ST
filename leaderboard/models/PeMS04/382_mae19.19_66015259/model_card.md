# 模型卡: darwin-st/66015259

- **数据集**: PeMS04
- **排名**: 第 382 名 / 库内 KEEP 实验
- **val MAE**: 19.19
- **val RMSE**: 31.33
- **参数量**: 181.9K
- **实验 id**: 135   **签名**: `66015259e2fc723856aa902ff08ac167e8bbfcf4`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-27T04:56:50.372633+00:00
...
- 时空块:
  ...
  4. spatial=`dynamic_gat` temporal=`identity` fusion=`parallel`
