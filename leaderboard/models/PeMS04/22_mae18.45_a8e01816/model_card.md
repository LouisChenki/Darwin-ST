...
- **val RMSE**: 30.58
- **参数量**: 196.8K
- **实验 id**: 331   **签名**: `a8e018160714a84dbb42fefe4d3a288078a783af`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T21:09:52.934008+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.65
...
- 时空块:
  ...
  5. spatial=`synth_StGraphAttnWithMpsGated_v3` temporal=`synth_InfoBootstrapResidual` fusion=`residual` 🔬
