# 模型卡: darwin-st/fbcc95a6

- **数据集**: PeMS04
- **排名**: 第 17 名 / 库内 KEEP 实验
- **val MAE**: 18.43
- **val RMSE**: 30.55
- **参数量**: 264.4K
- **实验 id**: 628   **签名**: `fbcc95a6c5c8f4c4a641cd7015c9c189562dd88b`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-05T20:52:37.668229+00:00
...
- 时空块:
  0. spatial=`synth_StGraphAttnWithMpsGated_v19` temporal=`identity` fusion=`cross` 🔬
