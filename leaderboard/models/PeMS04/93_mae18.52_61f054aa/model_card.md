# 模型卡: darwin-st/61f054aa

- **数据集**: PeMS04
- **排名**: 第 93 名 / 库内 KEEP 实验
- **val MAE**: 18.52
- **val RMSE**: 30.61
- **参数量**: 217.3K
- **实验 id**: 533   **签名**: `61f054aa3573c667073e37bc1024ec9a3eb52cef`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-03T20:05:46.807621+00:00
...
- 时空块:
  ...
  3. spatial=`dynamic_gat` temporal=`synth_StGraphAttnWithMpsGated_v18` fusion=`cross` 🔬
  4. spatial=`synth_InfoBootstrapResidual` temporal=`synth_StGraphAttnWithMpsGated_v13` fusion=`cross` 🔬
...
### `synth_StGraphAttnWithMpsGated_v18`
- **组合方式**: gated_routed
- **源机制 (跨域)**: minimal_predictive_sufficiency
- **该算子实测 MAE**: 18.77
- **算子代码**: [`operators/synth_StGraphAttnWithMpsGated_v18.py`](operators/synth_StGraphAttnWithMpsGated_v18.py)
