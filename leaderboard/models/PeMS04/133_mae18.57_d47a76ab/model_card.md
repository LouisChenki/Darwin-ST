# 模型卡: darwin-st/d47a76ab

- **数据集**: PeMS04
- **排名**: 第 133 名 / 库内 KEEP 实验
- **val MAE**: 18.57
- **val RMSE**: 30.65
- **参数量**: 232.3K
- **实验 id**: 327   **签名**: `d47a76aba69759ad3e2ae3e345b2f46c9c42345a`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T19:11:12.199329+00:00
...
- 时空块:
  ...
  3. spatial=`gat` temporal=`identity` fusion=`cross`
