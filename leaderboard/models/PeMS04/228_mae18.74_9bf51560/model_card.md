# 模型卡: darwin-st/9bf51560

- **数据集**: PeMS04
- **排名**: 第 228 名 / 库内 KEEP 实验
- **val MAE**: 18.74
- **val RMSE**: 30.77
- **参数量**: 262.2K
- **实验 id**: 637   **签名**: `9bf51560035f4c04c7f1f23ce3a04ec409068429`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-06T00:54:42.161771+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.94
...
- 时空块:
  ...
  5. spatial=`synth_StGraphAttnWithMpsGated_v4` temporal=`synth_InfoBootstrapResidual` fusion=`sequential_ts` 🔬
