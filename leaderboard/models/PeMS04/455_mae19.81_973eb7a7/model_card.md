# 模型卡: darwin-st/973eb7a7

- **数据集**: PeMS04
- **排名**: 第 455 名 / 库内 KEEP 实验
- **val MAE**: 19.81
- **val RMSE**: 31.90
- **参数量**: 173.0K
- **实验 id**: 396   **签名**: `973eb7a73ac7592189c1b56da944a890872aeace`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T01:15:15.593897+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +2.01
...
- 身份嵌入: node=False(96) tod=True(64) dow=True(64)
