# 模型卡: darwin-st/c8234b62

- **数据集**: PeMS04
- **排名**: 第 212 名 / 库内 KEEP 实验
- **val MAE**: 18.70
- **val RMSE**: 30.80
- **参数量**: 268.6K
- **实验 id**: 481   **签名**: `c8234b62a8fcde24dda1821e146a2d6c03c50ebf`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T17:41:31.575349+00:00
...
```json
{
  "lr": 0.005842832711241456,
  "weight_decay": 2.1735909719405236e-06,
  "dropout": 0.001068418168333092,
  "batch_size": 32,
  "lr_schedule": "plateau",
  "num_heads": 1
}
