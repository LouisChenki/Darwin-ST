# 模型卡: darwin-st/f0006d7c

- **数据集**: PeMS04
- **排名**: 第 509 名 / 库内 KEEP 实验
- **val MAE**: 22.62
- **val RMSE**: 35.88
- **参数量**: 184.1K
- **实验 id**: 410   **签名**: `f0006d7cf307183e81eea625a8d65bdd4c3f63f5`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T07:03:19.312226+00:00
...
- 时空块:
  ...
  5. spatial=`identity` temporal=`synth_InfoBootstrapResidual` fusion=`sequential` 🔬
