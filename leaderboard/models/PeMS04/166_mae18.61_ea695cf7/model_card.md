# 模型卡: darwin-st/ea695cf7

- **数据集**: PeMS04
- **排名**: 第 166 名 / 库内 KEEP 实验
- **val MAE**: 18.61
- **val RMSE**: 30.72
- **参数量**: 240.6K
- **实验 id**: 381   **签名**: `ea695cf727a124490ab20716652ec32b6e4d31f2`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T18:11:22.898830+00:00
...
- 时空块:
  0. spatial=`synth_StGraphAttnWithMpsGated_v7` temporal=`identity` fusion=`iterative` 🔬
