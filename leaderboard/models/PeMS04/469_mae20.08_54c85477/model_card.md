# 模型卡: darwin-st/54c85477

- **数据集**: PeMS04
- **排名**: 第 469 名 / 库内 KEEP 实验
- **val MAE**: 20.08
- **val RMSE**: 32.43
- **参数量**: 151.6K
- **实验 id**: 199   **签名**: `54c854774cf3979fdcbbbe8cc05493eec2982687`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-28T07:40:05.858436+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +2.28
