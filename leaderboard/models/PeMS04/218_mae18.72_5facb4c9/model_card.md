# 模型卡: darwin-st/5facb4c9

- **数据集**: PeMS04
- **排名**: 第 218 名 / 库内 KEEP 实验
- **val MAE**: 18.72
- **val RMSE**: 30.85
- **参数量**: 218.2K
- **实验 id**: 355   **签名**: `5facb4c9f81abf9e57cc7aa615f50ce49ea87ce9`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T06:55:01.274063+00:00
...
- 时空块:
  ...
  2. spatial=`synth_StGraphAttnWithMpsGated_v7` temporal=`st_separable` fusion=`cross` 🔬
