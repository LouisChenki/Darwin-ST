# 模型卡: darwin-st/96972bd2

- **数据集**: PeMS04
- **排名**: 第 211 名 / 库内 KEEP 实验
- **val MAE**: 18.70
- **val RMSE**: 30.80
- **参数量**: 227.5K
- **实验 id**: 464   **签名**: `96972bd2516da11b4900648f96b37db05c2a569b`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-02T09:31:56.665250+00:00
...
- 时空块:
  ...
  5. spatial=`stjoint_conv` temporal=`multiscale_tcn` fusion=`residual`
