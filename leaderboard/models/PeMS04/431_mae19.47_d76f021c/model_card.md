# 模型卡: darwin-st/d76f021c

- **数据集**: PeMS04
- **排名**: 第 431 名 / 库内 KEEP 实验
- **val MAE**: 19.47
- **val RMSE**: 31.66
- **参数量**: 430.3K
- **实验 id**: 28   **签名**: `d76f021cd3ee953b91ba3f4f65fbc9cea6c61d18`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-25T00:46:24.012846+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.67
- **评测协议**: masked metric; MAE averaged over 12 horizons; split 6/2/2

## 架构

- 深度 (blocks): 2   hidden: 128   邻接: none
- 时空块:
