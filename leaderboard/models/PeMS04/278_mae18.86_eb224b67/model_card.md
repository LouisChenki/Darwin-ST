# 模型卡: darwin-st/eb224b67

- **数据集**: PeMS04
- **排名**: 第 278 名 / 库内 KEEP 实验
- **val MAE**: 18.86
- **val RMSE**: 30.95
- **参数量**: 182.0K
- **实验 id**: 170   **签名**: `eb224b67e083c13d9490af73b3e13173afb362f1`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-27T19:46:38.605793+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.06
...
- 时空块:
  0. spatial=`synth_StGraphAttnWithMpsGated_v5` temporal=`st_graph_attn` fusion=`cross` 🔬
