# 模型卡: darwin-st/f1046dd5

- **数据集**: PeMS04
- **排名**: 第 458 名 / 库内 KEEP 实验
- **val MAE**: 19.89
- **val RMSE**: 32.05
- **参数量**: 179.4K
- **实验 id**: 419   **签名**: `f1046dd5d9812192e6a9ff9793226438846cebfb`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T11:58:11.906939+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +2.09
...
- 时空块:
  ...
  4. spatial=`synth_StGraphAttnWithMpsGated_v17` temporal=`stjoint_conv` fusion=`cross` 🔬
  5. spatial=`synth_StGraphAttnWithMpsGated_v4` temporal=`synth_InfoBootstrapResidual` fusion=`residual` 🔬
- 身份嵌入: node=False(64) tod=True(64) dow=True(64)
