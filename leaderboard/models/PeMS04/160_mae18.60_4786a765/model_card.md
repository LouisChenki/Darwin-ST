# 模型卡: darwin-st/4786a765

- **数据集**: PeMS04
- **排名**: 第 160 名 / 库内 KEEP 实验
- **val MAE**: 18.60
- **val RMSE**: 30.68
- **参数量**: 266.4K
- **实验 id**: 513   **签名**: `4786a765834a2f1f78a7bc6c7e8b9cccf0c472e5`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-03T10:07:29.984104+00:00
...
```json
{
  "lr": 0.0073426099525271925,
  "weight_decay": 1.093116182881069e-06,
  "dropout": 0.25871039414609803,
  "batch_size": 32,
  "lr_schedule": "cosine",
  "num_heads": 8
}
