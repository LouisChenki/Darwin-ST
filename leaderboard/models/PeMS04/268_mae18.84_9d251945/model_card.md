# 模型卡: darwin-st/9d251945

- **数据集**: PeMS04
- **排名**: 第 268 名 / 库内 KEEP 实验
- **val MAE**: 18.84
- **val RMSE**: 30.96
- **参数量**: 208.6K
- **实验 id**: 397   **签名**: `9d2519456949bb0f851831d311face78df9a7a51`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-01T01:18:00.627633+00:00
...
- 时空块:
  ...
  2. spatial=`adaptive` temporal=`st_separable` fusion=`residual`
...
- 身份嵌入: node=True(96) tod=True(64) dow=True(64)
