# 模型卡: darwin-st/46e321ab

- **数据集**: PeMS04
- **排名**: 第 517 名 / 库内 KEEP 实验
- **val MAE**: 22.80
- **val RMSE**: 36.24
- **参数量**: 186.4K
- **实验 id**: 571   **签名**: `46e321ab2ed917eee3911fba42bc54e1e660c19c`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-04T13:48:11.416902+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +5.00
...
- 时空块:
  ...
  1. spatial=`st_separable` temporal=`synth_StGraphAttnWithMpsGated_v9` fusion=`cross` 🔬
