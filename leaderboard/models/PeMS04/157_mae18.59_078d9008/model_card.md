# 模型卡: darwin-st/078d9008

- **数据集**: PeMS04
- **排名**: 第 157 名 / 库内 KEEP 实验
- **val MAE**: 18.59
- **val RMSE**: 30.67
- **参数量**: 195.2K
- **实验 id**: 270   **签名**: `078d9008e20c719a775b75769a640cfd87fdfe1f`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-29T17:37:10.577114+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.79
- **评测协议**: masked metric; MAE averaged over 12 horizons; split 6/2/2

## 架构

- 深度 (blocks): 5   hidden: 64   邻接: sym
- 时空块:
