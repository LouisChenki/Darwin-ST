# 模型卡: darwin-st/386a4017

- **数据集**: PeMS04
- **排名**: 第 414 名 / 库内 KEEP 实验
- **val MAE**: 19.34
- **val RMSE**: 31.37
- **参数量**: 258.2K
- **实验 id**: 596   **签名**: `386a4017628757e2f269c906fce7185671e97c45`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-05T03:21:19.031918+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.54
...
- 时空块:
  0. spatial=`gat` temporal=`identity` fusion=`cross`
  ...
  4. spatial=`synth_ParallelMinimalSufficiencyAttn` temporal=`stjoint_conv` fusion=`cross` 🔬
...
- 身份嵌入: node=True(128) tod=False(64) dow=True(64)
