# 模型卡: darwin-st/f7481346

- **数据集**: PeMS04
- **排名**: 第 233 名 / 库内 KEEP 实验
- **val MAE**: 18.75
- **val RMSE**: 30.81
- **参数量**: 242.0K
- **实验 id**: 618   **签名**: `f7481346daada413ac895ec379747bd26feb6131`
- **run_tag**: exp/tier2-v1   **时间**: 2026-08-05T15:35:11.545134+00:00
...
- 时空块:
  ...
  2. spatial=`adaptive` temporal=`stjoint_conv` fusion=`cross`
