# 模型卡: darwin-st/86a836bf

- **数据集**: PeMS04
- **排名**: 第 159 名 / 库内 KEEP 实验
- **val MAE**: 18.59
- **val RMSE**: 30.66
- **参数量**: 242.6K
- **实验 id**: 341   **签名**: `86a836bf5ba422cc6b113c618fe32f4662d629f1`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T00:45:43.633567+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +0.79
...
- 时空块:
  ...
  6. spatial=`synth_st_graph_attn_with_vib_compression` temporal=`tcn` fusion=`cross` 🔬
