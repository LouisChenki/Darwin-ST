# 模型卡: darwin-st/2e2c8b1c

- **数据集**: PeMS04
- **排名**: 第 452 名 / 库内 KEEP 实验
- **val MAE**: 19.71
- **val RMSE**: 31.74
- **参数量**: 225.9K
- **实验 id**: 333   **签名**: `2e2c8b1cb45a7374aca694add3f290dd41ee8421`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T21:12:56.346172+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.91
...
- 时空块:
  ...
  1. spatial=`st_separable` temporal=`st_graph_attn` fusion=`sequential_ts`
