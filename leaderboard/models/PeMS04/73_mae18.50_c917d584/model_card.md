# 模型卡: darwin-st/c917d584

- **数据集**: PeMS04
- **排名**: 第 73 名 / 库内 KEEP 实验
- **val MAE**: 18.50
- **val RMSE**: 30.59
- **参数量**: 194.4K
- **实验 id**: 302   **签名**: `c917d58472c5020aeec280a7159d54b4e8423814`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-30T08:12:08.256495+00:00
...
- 时空块:
  ...
  5. spatial=`adaptive` temporal=`synth_InfoBootstrapResidual` fusion=`residual` 🔬
