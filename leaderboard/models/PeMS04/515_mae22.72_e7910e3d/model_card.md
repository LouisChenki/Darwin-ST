# 模型卡: darwin-st/e7910e3d

- **数据集**: PeMS04
- **排名**: 第 515 名 / 库内 KEEP 实验
- **val MAE**: 22.72
- **val RMSE**: 36.09
- **参数量**: 727.2K
- **实验 id**: 284   **签名**: `e7910e3df0a3d752282ee67673002dc7accb9d77`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-29T23:48:30.820833+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +4.92
...
- 时空块:
  ...
  3. spatial=`dynamic_gat` temporal=`synth_StGraphAttnWithMpsGated_v9` fusion=`cross` 🔬
