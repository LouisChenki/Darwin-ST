# 模型卡: darwin-st/3b9179c9

- **数据集**: PeMS04
- **排名**: 第 138 名 / 库内 KEEP 实验
- **val MAE**: 18.57
- **val RMSE**: 30.69
- **参数量**: 232.4K
- **实验 id**: 392   **签名**: `3b9179c9aab8e26ea64d6ae5d0caf248c0b5380d`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T23:21:35.889332+00:00
...
- 时空块:
  ...
  3. spatial=`identity` temporal=`identity` fusion=`cross`
