# 模型卡: darwin-st/3b63da65

- **数据集**: PeMS04
- **排名**: 第 363 名 / 库内 KEEP 实验
- **val MAE**: 19.10
- **val RMSE**: 31.25
- **参数量**: 224.0K
- **实验 id**: 99   **签名**: `3b63da658a91b72b573055f82ace821586bdbcb6`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-26T09:33:29.240184+00:00
...
- 时空块:
  ...
  3. spatial=`gat` temporal=`stjoint_conv` fusion=`parallel`
