# 模型卡: darwin-st/18513e68

- **数据集**: PeMS04
- **排名**: 第 269 名 / 库内 KEEP 实验
- **val MAE**: 18.84
- **val RMSE**: 31.03
- **参数量**: 169.5K
- **实验 id**: 214   **签名**: `18513e6871a15446a8a4075c9e96c88477086a27`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-28T12:22:50.313370+00:00
...
- 时空块:
  0. spatial=`synth_ParallelMinimalSufficiencyAttn` temporal=`st_graph_attn` fusion=`cross` 🔬
