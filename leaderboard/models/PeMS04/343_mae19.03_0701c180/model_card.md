# 模型卡: darwin-st/0701c180

- **数据集**: PeMS04
- **排名**: 第 343 名 / 库内 KEEP 实验
- **val MAE**: 19.03
- **val RMSE**: 31.04
- **参数量**: 255.8K
- **实验 id**: 373   **签名**: `0701c180a6484137aba3cab5434174fdc7bde8d5`
- **run_tag**: exp/tier2-v1   **时间**: 2026-07-31T14:20:56.761150+00:00
- **vs SOTA** (STD-MAE 17.80): 距 SOTA 差 +1.23
...
- 时空块:
  0. spatial=`synth_StGraphAttnWithMpsGated_v7` temporal=`synth_StGraphAttnWithMpsGated_v2` fusion=`cross` 🔬
  1. spatial=`synth_StGraphAttnWithMpsGated_v13` temporal=`st_graph_attn` fusion=`cross` 🔬
  2. spatial=`synth_ParallelMinimalSufficiencyAttn` temporal=`st_separable` fusion=`cross` 🔬
