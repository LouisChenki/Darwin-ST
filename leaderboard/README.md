...
| **v2**<br>Stage1 搜索空间升级（joint/cross/iterative fusion）+ 24h 长跑 | 2026-07-01 | **18.349** | +0.55 | **5** / 12 | `v-sota-pems04-18.35` | [复盘](../docs/SOTA_RETROSPECTIVE.md) |
| **v3**<br>Tier-2 v1 方法升级（履历/家谱精炼/proxy/信用分/独立采样 + 631 卡机制库） | 2026-08-07 | **18.356** | +0.56 | **6** / 12 | `acceptable+18.356` | [复盘](../docs/TIER2_V1_RETROSPECTIVE.md) |
...
- **v3** (2026-08-07): Best MAE **18.356**, 榜单位次 **6** / 12, 距 SOTA (STD-MAE 17.80) +0.56
- 模型卡: [models/PeMS04/06_mae18.36_6bcc97b9](models/PeMS04/06_mae18.36_6bcc97b9/)
